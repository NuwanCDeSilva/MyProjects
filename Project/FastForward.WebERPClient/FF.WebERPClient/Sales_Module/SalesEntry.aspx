<%@ Page Title="Invoice" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SalesEntry.aspx.cs" Inherits="FF.WebERPClient.Sales_Module.SalesEntry"
...
<script type="text/javascript" >
    ...
    function SelectAll(Id) {
        ...
        function TabModalPopupInBusinessEntityOpen() {
            ...
            window.open('../General_Modules/CustomerCreation.aspx', '_blank');
        ...
        function OnSuccessPriceBook(result) {
            var txtPriceBook = document.getElementById('<%= txtPriceBook.ClientID %>');
            var txtPriceLevel = document.getElementById('<%= txtPriceLevel.ClientID %>');
            if (result == false) {
        ...
        //#region Check Group Sale Code
        function CheckGroupSalesCode() {
            var txtGroup = document.getElementById('<%= txtGroup.ClientID %>');
            var txtInvType = document.getElementById('<%= txtInvType.ClientID %>');

            if (txtGroup.value == '' || txtGroup.value == null) { return; }
            ...
            if (txtInvType.value != '') {
                if (txtInvType.value != 'CRED') {
                    alert('Group sales only available for credit sales!');
                    txtGroup.value = '';
                    txtGroup.focus();
                    return;
                }
            }
            FF.WebERPClient.LocalWebServices.CommonSearchWebServive.IsValidGroupSaleCode(txtGroup.value, OnSuccessGroupSaleCode, OnFailGroupSaleCode);
        }

        function OnSuccessGroupSaleCode(result) {
            var txtGroup = document.getElementById('<%= txtGroup.ClientID %>');
            if (result.Hgr_com == null) { 
                txtGroup.value = '';
                alert('Invalid Group Sale Code!');
                txtGroup.focus();
                return;
            }
            var _glcompanycode = result.Hgr_Grup_com;
            var txtCustomer = document.getElementById('<%= txtCustomer.ClientID %>');
            txtCustomer.value = _glcompanycode;
            CustomerDetailClear();
            CheckByCustomer();
        }

        function OnFailGroupSaleCode(error) {
            var txtGroup = document.getElementById('<%= txtGroup.ClientID %>');
            txtGroup.value = '';
            alert('Invalid Group Sale Code!');
            txtGroup.focus();
        ...
        function btnEditBtn_click(val) {
            var _editBtn = document.getElementById('<%= btnEditQty.ClientID %>');
            var _edithdn = document.getElementById('<%= hdnEditQty.ClientID %>');
            _edithdn.value = val;
            _editBtn.click();
        }
        ...
        <ContentTemplate>
            ...
            <div class="inv100break">
                ...
                <div  class="PanelHeader invheadersize">
                    <div  Style="float:left;"> <asp:Label runat="server" ID="lblDispalyInfor" Text="" Style="float:left;overflow-y:auto;overflow-x:auto; font-size:xx-small; color:Yellow;  "></asp:Label>
                    </div>
                    ...
                    <asp:Button ID="btnSave" runat="server" Text="Process" 
                        CssClass="Button invbtn" OnClick="SaveInvoice" />
                    <asp:Button ID="btnHold" runat="server" Text="Hold"  CssClass="Button invbtn"
                        OnClick="Hold" />
                    <asp:Button ID="btnClear" runat="server" Text="Clear"  CssClass="Button invbtn"
                        OnClick="btnClear_Click" />
                    <asp:Button ID="btnCancel" runat="server" Text="Cancel" style="background-color:Red;color:White;" 
                        OnClick="Cancel" CssClass="Button invbtn" />
                    <asp:Button ID="btnPrint" runat="server" Text="Print"  OnClick="Print"
                        CssClass="Button invbtn" />
                    <asp:Button ID="btnDOPrint" runat="server" Text="Print DO"  OnClick="Print"
                        CssClass="Button invbtn" />
                </div>
                ...
                <div class="div97pcelt" >
                    <div class="inv100pceltpd2">
                        ...
                        <div class="div21pcelt">
                            &nbsp;  &nbsp; &nbsp;  &nbsp;Group &nbsp; <asp:TextBox runat="server" ID="txtGroup" CssClass="TextBox" Width="45%" onblur="CheckGroupSalesCode()"  ></asp:TextBox>&nbsp;<asp:ImageButton ID="imgBtnGroup" runat="server" ImageUrl="~/Images/icon_search.png" OnClick="imgbtnSearchGrpCode_Click"
                    ...
                    <div class="inv100pceltpd2">
                        ...
                        <div class="div10pcelt">
                            <asp:TextBox ID="txtCustomer" onchange="ToUpper(this)" runat="server" onblur="CheckByCustomer()"
                                Width="100%" CssClass="TextBoxUpper" MaxLength="10"></asp:TextBox></div>
                        <div class="div4pcelt">
                        ...
                        <div class="div46pcelt">
                            <asp:TextBox ID="txtCusName" onchange="ToUpper(this)" runat="server" Width="100%"
                                CssClass="TextBoxUpper" MaxLength="50"></asp:TextBox></div>
                        <div class="div5pcelt">
                            &nbsp;</div>
                        <div class="div6pcelt">
                            Currency
                    ...
                    <div class="inv100pceltpd2">
                        ...
                        <div class="invlblaccx">
                            <asp:TextBox ID="txtAccBalance" runat="server" Width="95%" ReadOnly="true" 
                                BorderStyle="None" BackColor="#E6EBF2" Text="0.00" class="invtxtacc"></asp:TextBox></div>
                    </div>
                    <%--Third Row--%>
                    <div class="inv100pceltpd2">
                        <div class="div1pcelt">
                ...
                <div class="invunkwn1">
                    <div>
                        <asp:ImageButton class="invadvbtn" ID="btnBusAdvDetail"
                            runat="server" OnClientClick="TabModalPopupInBusinessEntityOpen()" ImageAlign="Middle"
                            ImageUrl="~/Images/customer2.jpg"  ToolTip="Advance Customer Creation" /></div>
                    <div>
                        <asp:ImageButton CssClass="invadvbtn2" ID="btnApplyDiscount" runat="server"
                            OnClick="BindInvoiceItemToDiscountItem" ImageAlign="Middle" ImageUrl="~/Images/discount_icon.jpg"
                            ToolTip="Customer Discount Request" /></div>
                    <div>
                ...
                <div class="invunkwn2">
                    ...
                    <asp:CollapsiblePanelExtender ID="CPEInvoiceItem" runat="server" TargetControlID="pnlInvItem"
                        CollapsedSize="0" ExpandedSize="225" Collapsed="False" ExpandControlID="Image1"
                        ...
                        <asp:Panel runat="server" ID="pnlInvItem" Width="99.8%" ScrollBars="Auto" BorderColor="#9F9F9F" 
                            ...
                            <div class="invunkwn4">
                                <div class="invunkwn5">
                                    ...
                                    <div class="div8pcelt">
                                        <asp:CheckBox runat="server" ID="chkSearchBySerial" Text="By Serial" onchange="OnBySerialCheckChange()" ClientIDMode="Static" />
                                    </div>
                                    <div class="div1pcelt">
                                        &nbsp;</div>
                            ...
                            <div class="invunkwn4">
                                ...
                                <div class="invunkwn18">
                                    <asp:TextBox runat="server" ID="txtQty" CssClass="TextBox" class="invtxtalnrt"
                                        Width="87.5%"></asp:TextBox></div>
                                ...
                                <div class="invunkwn19">
                                    <asp:TextBox runat="server" ID="txtVATAmt" CssClass="TextBox" class="invtxtalnrt"
                                        Width="94.4%"></asp:TextBox></div>
                                <div class="invunkwn19">
                                    <asp:TextBox runat="server" ID="txtTotalAmt" Style="text-align: right; font-size:11px;" Width="100%"
                                        BackColor="#EEEEEE" BorderWidth="0px" ReadOnly="true"></asp:TextBox></div>
                                <div class="invunkwn20">
                                    &nbsp;</div>
                                <div class="div1pcelt">
                                    <asp:ImageButton runat="server" ID="btnAddItem" OnClick="AddItem" ImageAlign="Middle"
                                        ImageUrl="~/Images/download_arrow_icon.png" ToolTip="Add Item" Width="16px" Height="16px" />
                                </div>
                            ...
                            <div class="invunkwn21">
                                <asp:Panel ID="pnlItem" runat="server" Height="125px" ScrollBars="Auto" BorderColor="#9F9F9F"
                                    ...
                                    <asp:GridView ID="gvInvoiceItem" CssClass="GridView" runat="server" AutoGenerateColumns="false" 
                                        Font-Bold="false" CellPadding="3" OnRowDeleting="OnRemoveFromInvoiceItemGrid" OnRowCommand="OnRowSelectCommand"
                                        ForeColor="#333333" GridLines="Both" DataKeyNames="sad_itm_cd,sad_itm_stus,sad_unit_rt,sad_pbook,sad_pb_lvl,Sad_qty,sad_disc_amt,sad_itm_tax_amt,sad_promo_cd,sad_is_promo,sad_job_line"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ItemStyle-Width="5px" >
                                             ...
                                             <asp:TemplateField ItemStyle-Width="5px" >
                                                <ItemTemplate >
                                                    <asp:ImageButton ID="imgBtnPickSerial" runat="server" ImageUrl="~/Images/Add-16x16x16.ICO" CommandName="PICK" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Sad_itm_line" ) %>'
                                                        Width="14px" Height="14px" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField='Sad_do_qty' HeaderText='Pick' ItemStyle-Width="5px"  HeaderStyle-HorizontalAlign="Left"  />
                                ...
                                <div class="div16pcelt">
                                    <asp:TextBox runat="server" onchange="ToUpper(this)" ID="txtExecutive" CssClass="TextBoxUpper"
                                        Width="55%" MaxLength="10"></asp:TextBox>&nbsp;<asp:ImageButton ID="imgBtnExecutive"
                                            runat="server" ImageUrl="~/Images/icon_search.png" ImageAlign="Middle" OnClick="imgBtnExecutive_Click" /></div>
                                <div class="div1pcelt">
                                    &nbsp;</div>
                                <div class="div16pcelt">
                                    Manual Ref. No
                ...
                <div class="invunkwn39">
                    ...
                    <asp:CollapsiblePanelExtender ID="CPEPayment" runat="server" TargetControlID="pnlPayment"
                        CollapsedSize="0" ExpandedSize="165" Collapsed="false" ExpandControlID="Image4"
                                    ...
                                    <asp:Panel ID="pnlPay" runat="server" Height="120px" ScrollBars="Auto">
                                        <asp:GridView ID="gvPayment" runat="server" AutoGenerateColumns="False" CssClass="GridView"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField='sard_anal_3' HeaderText='Bank chg' />
                    ...
                    <div class="invunkwn59">
                        <div class="invunkwn60">
                            ...
                            <div class="div77pcelt">
                                ...
                                &nbsp;
                                <asp:ImageButton ID="ImageBtnLoc" runat="server" ImageUrl="~/Images/icon_search.png"
                                                    ImageAlign="Middle" OnClick="imgBtnLocClick" />
                                &nbsp;
...
<%--                        <div class="invunkwn60">
                        ...
                        <div class="invunkwn60">
                            ...
                            <div class="div55pcelt">
                                <asp:TextBox runat="server" onchange="ToUpper(this)" ID="txtDelAddress1" CssClass="TextBox"
                                    Width="100%" MaxLength="200"></asp:TextBox></div>
                        </div>
                        <div class="invunkwn60">
                            <div class="div1pcelt">
                                &nbsp;</div>
            ...
            <%-- Modal Popup Extenders for price pick/serialized price pick--%>
            <div>
                ...
                <asp:Panel ID="pnlPopUp" runat="server" Height="550px" Width="500px" CssClass="ModalWindow">
                    ...
                    <asp:Panel runat="server" ID="pnlPopMain" Width="100%" ScrollBars="None">
                        ...
                        <div  class="invunkwn62"
                            runat="server" id="divPopSerialPriceList" visible="false">
                            <%-- Confirm Button Area --%>
                            <div class="inv100break">
                                <div class="div1pcelt">
                                    &nbsp;</div>
                        ...
                        <div class="invunkwn65" runat="server" id="divPopPriceList"
                            visible="false">
                            <%-- Confirm Button Area --%>
                            <div class="inv100break">
                                <div class="div1pcelt">
                        ...
                        <div class="invunkwn65" runat="server" id="divConsumPricePick"
                            visible="false">
                            <%-- Confirm Button Area --%>
                            <div class="inv100break">
                                <div class="div1pcelt">
                        ...
                        <div class="invunkwn65" runat="server" id="divPopPriceItemCombination"
                            visible="false">
                            <%-- Confirm Button Area --%>
                            ...
                            <asp:Panel ID="pnlPopItemCombine" runat="server" ScrollBars="Auto" Height="100px"
                                ...
                                <asp:GridView ID="gvPriceItemCombine" runat="server" AutoGenerateColumns="false"
                                    OnRowDataBound="gvPriceItemCombine_OnRowBind" CssClass="GridView" CellPadding="4" OnSelectedIndexChanged="LoadSelectedpPriceComSerialForPriceComItemSerialGv"
                                    ForeColor="#333333" GridLines="Both" DataKeyNames="sapc_qty,sapc_main_itm_cd,sapc_pb_seq,sapc_main_line,sapc_itm_line,sapc_main_ser,sapc_itm_cd" >
                                    <EditRowStyle BackColor="#2461BF" />
                                    <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                    <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                    <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Selected Qty" HeaderStyle-HorizontalAlign="Right"
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtPopPriceItmComSelQty" Enabled="false" runat="server" Width="100%" Text='<%# DataBinder.Eval(Container.DataItem, "sapc_qty") %>'
                            ...
                            <div runat="server" id="divPopPriceComSerialPick" >
                                <div class="invunkwn68">
                                    ...
                                    <div  class="invunkwn70">
                                        <asp:Button runat="server" ID="btnPopPriceComSerAdd" CssClass="Button" Text="Add Serial" OnClick="AddPriceComItemSerialToList" />
                                    </div>
                                </div>
                                <asp:Panel runat="server" ID="pnlPopPriceComSerPnl"  Width="100%" Height="200px" ScrollBars="Auto" >
                                    <asp:GridView runat="server" ID="gvPopPriceComSerPick" AutoGenerateColumns="false"  CssClass="GridView" CellPadding="3" ForeColor="#333333" GridLines="Both" ShowHeaderWhenEmpty="true" Width="100%"  >
                                            <EditRowStyle BackColor="#2461BF" />
                                            <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                            <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                            <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
            ...
            <div>
                ...
                PopupDragHandleControlID="divSerialHeader">
                 ...
                 <asp:Panel ID="pnlSerial" runat="server" Height="200px" Width="955px" CssClass="ModalWindow">
                    ...
                    <asp:Panel runat="server" ID="pnlPopSerialgv" ScrollBars="Auto" Width="950px" Height="165px"    BorderStyle="Solid" BorderColor="Black" BorderWidth="1px" >
                        <asp:GridView runat="server" ID="gvPopSerial" AutoGenerateColumns="false" CssClass="GridView" CellPadding="3" ForeColor="#333333" GridLines="Both" ShowHeaderWhenEmpty="true" OnRowDeleting="OnRemoveFromInvoiceItemSerialGrid"
                        DataKeyNames="Tus_itm_cd,Tus_serial_id,Tus_unit_price,Tus_base_itm_line,Tus_new_status,Tus_ser_1" >
                            <AlternatingRowStyle BackColor="White" />
                            <EmptyDataTemplate>  <div class="invunkwn66">  No data found  </div>  </EmptyDataTemplate>
                            <Columns>
                                <asp:BoundField DataField='tus_itm_cd' HeaderText='Item'>
            ...
            <div>
                <asp:ModalPopupExtender ID="MPEComItemSerial" RepositionMode="RepositionOnWindowScroll"
                    BehaviorID="ComItemSerial" TargetControlID="btnComItemSerial" runat="server" ClientIDMode="Static"
                    PopupControlID="pnlComItemSerial" BackgroundCssClass="modalBackground" CancelControlID="imgBtnComItemSerClose"
                    PopupDragHandleControlID="divComItemSerialHeader">
                </asp:ModalPopupExtender>
                <asp:Panel runat="server" ID="pnlComItemSerial" Height="300px" Width="500px" CssClass="ModalWindow" >
                    ...
                    <div class="popUpHeader" id="divComItemSerialHeader" runat="server"> 
                        <div class="div80pcelt" runat="server" >  Combine Item Serial Pick </div>
                    </div>
                    <%-- PopUp Message Area --%>
                    <div class="invunkwn58">
                        <asp:Label ID="lblComItemSerMsg" runat="server" Text="" Width="100%"></asp:Label> &nbsp; <asp:Button runat="server" ID="btnPopComItemSerConfirm" CssClass="Button" Text="Confirm" OnClick="ConfirmComItemSerialWithQty" /> &nbsp; <asp:Button runat="server" ID="btnPopComItemSerCancel" CssClass="Button" Text="Cancel" OnClick="ConfirmComItemSerialCancel" />
                    </div>
                    <div class="invunkwn5">
                        <asp:Panel runat="server" ID="pnlComItemgv" ScrollBars="Auto" class="invunkwn67"  >
                            <asp:GridView runat="server" ID="gvPopComItem" AutoGenerateColumns="false"  CssClass="GridView" CellPadding="3" ForeColor="#333333" GridLines="Both" ShowHeaderWhenEmpty="true" DataKeyNames="Micp_itm_cd,Micp_qty" OnSelectedIndexChanged="LoadSelectedItemSerialForComItemSerialGv" OnRowDataBound="gvComItemSerialBind" >
                                    <EditRowStyle BackColor="#2461BF" />
                                    <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                    <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                    <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
                        ...
                        <div class="invunkwn68">
                            ...
                            <div  class="invunkwn70">
                                <asp:Button runat="server" ID="btnPopComItemSerAdd" CssClass="Button" Text="Add Serial" OnClick="AddComItemSerialToList" />
                            </div>
                        </div>
                        <asp:Panel runat="server" ID="pnlComItemSerialgv" class="invunkwn71">
                            <asp:GridView runat="server" ID="gvPopComItemSerial" AutoGenerateColumns="false"  CssClass="GridView" CellPadding="3" ForeColor="#333333" GridLines="Both" ShowHeaderWhenEmpty="true" OnRowDataBound="gvComItemSerialWithSerialOnBind" >
                                    <EditRowStyle BackColor="#2461BF" />
                                    <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                    <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                    <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
            ...
            <div>
                ...
                <asp:Panel runat="server" ID="pnlComItemMulti" Height="300px" Width="500px" CssClass="ModalWindow" >
                    <div class="popUpHeader" id="divComItemMultiHeader" runat="server"> 
                        <div class="div80pcelt" >  Pick an item </div>
                    </div>
                    <div class="invunkwn5">
                         <asp:Panel runat="server" ID="Panel3" ScrollBars="Auto" class="invunkwn72" >
                            <div runat="server" id="divMultiResult"></div>
                         </asp:Panel>
                    </div>
                </asp:Panel>
            </div>
            ...
            <div>
                <asp:ModalPopupExtender ID="MPEItemSerialItm" RepositionMode="RepositionOnWindowScroll"
                    BehaviorID="ItemSerialItm" TargetControlID="btnItemSerialItm" runat="server" ClientIDMode="Static"
                    PopupControlID="pnlItemSerialItm" BackgroundCssClass="modalBackground" CancelControlID="imgBtnItemSerItmClose"
                    PopupDragHandleControlID="divComItemSerialItmHeader">
                </asp:ModalPopupExtender>
                <asp:Panel runat="server" ID="pnlItemSerialItm" Height="300px" Width="700px" CssClass="ModalWindow" >
                    <div class="popUpHeader" id="divComItemSerialItmHeader" runat="server"> 
                        <div class="div80pcelt" runat="server" >  Item wise Serial Pick </div>   <div class="invunkwn61">
                    ...
                    <div class="invunkwn5">
                        <asp:Panel runat="server" ID="pnlSerialInvItem" class="invunkwn73">
                            <asp:GridView runat="server" ID="gvPickItemSerial" AutoGenerateColumns="false"  CssClass="GridView" CellPadding="3" ForeColor="#333333" GridLines="Both" ShowHeaderWhenEmpty="true"  >
                                    <EditRowStyle BackColor="#2461BF" />
                                    <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                    <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                    <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
                ...
                <asp:Panel ID="PanelItemPopUp" runat="server" Height="320px" Width="642px" BackColor="#A7C2DA"
                    ...
                    <div style="float: left; width: 100%; height: 22px; text-align: right; padding-top: 2px">
                        ...
                        <div id="divPopupImg" runat="server" visible="false" style="float: left; width: 3%;
                            ...
                            <asp:Image ID="Image3" runat="server" ImageUrl="~/Images/warning.gif" Width="15px"
                                Height="15px" />
                        </div>
            ...
            <div style="display: none;">
                ...
                <asp:Button ID="btnQuotation" runat="server" OnClick="LoadQuotationItem" />
