...
{
    public partial class ItemProfile : BasePage
    {
        ...
        void Load_items()
        {
            ...
            if (_item != null)
            {
              ...
              //  txtPartNo.Text=   _item.Mi_part_cd ;
                ...
                chkAllowMinus.Checked = _item.Mi_anal4 == true ? true : false; //Added By Dulaj 2018/Jul/13
        ...
        private void CollectMaster()
        {
           ...
           // _item.Mi_is_stockmaintain = chkStcokMain.Checked == true ? "1" : "0";
            ...
            _item.Mi_anal4 = chkAllowMinus.Checked;
...
//if (string.IsNullOrEmpty(txtPartNo.Text)) { DisplayMessage("Enter part No", 2); return; }
          //  if (string.IsNullOrEmpty(txtPackCode.Text)) { DisplayMessage("Enter paking code", 2); return; }
           ...
           // if (string.IsNullOrEmpty(ttxHsCode.Text)) { DisplayMessage("Enter HS code", 2); return; }
            ...
            int row_aff = CHNLSVC.General.SaveItemMaster(_item, _lstchannelWrd, _lstpcWrd, _lstitmWrd, _lstitmPrd, _lsttaxClaim, _lstcont, _lstkit, _lstreplace, _lstmrn, _lstredCom, _lstsupItem, _lstcusItem, _lstcomItem, _lstreorder, _lstfg_cost,_itemPrefix, _isAutoCode, Session["UserCompanyCode"].ToString(), out _err);
            if (row_aff == 1)
            {
