...
namespace FF.WindowsERPClient.Reports.Sales {
    ...
    public class DF_Sales_Qty : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "FF.WindowsERPClient.Reports.Sales.DF_Sales_Qty.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedDF_Sales_Qty : Component, ICachedReport {
        
        public CachedDF_Sales_Qty() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            DF_Sales_Qty rpt = new DF_Sales_Qty();
            rpt.Site = this.Site;
            return rpt;
        }
