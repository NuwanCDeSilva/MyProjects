...
{
    public class PrintTest : BasePage
    {
        public string Display()
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(GlbSelectionFormula)) //Sanjeewa 2012-07-21
                {
                    rr.RecordSelectionFormula = GlbSelectionFormula;
                }
                if (Session["defaultPrinter"] != null)
                    rr.PrintOptions.PrinterName = Session["defaultPrinter"].ToString();
                else
                    return "er";
                

                
                // rr.PrintOptions.PrinterName="\\\\10.12.10.36\\HP LaserJet P1005";
