...
namespace FF.BusinessObjects
{
    ...
    // Computer :- ITPD11  | User :- suneth On 17-Dec-2014 10:11:03
    //===========================================================================================================

    public class Service_warranty_Approval
    {
        ...
        public static Service_warranty_Approval Converter(DataRow row)
        {
            return new Service_warranty_Approval
            {
    ...
    public class Scv_wrrt_App
    {
        ...
        public static Scv_wrrt_App Converter(DataRow row)
        {
            return new Scv_wrrt_App
            {
                Insa_dt = row["INSA_DT"] == DBNull.Value ? DateTime.MinValue : Convert.ToDateTime(row["INSA_DT"].ToString()),
                Insa_manual_ref = row["INSA_MANUAL_REF"] == DBNull.Value ? string.Empty : row["INSA_MANUAL_REF"].ToString(),
                Insa_tp = row["INSA_TP"] == DBNull.Value ? string.Empty : row["INSA_TP"].ToString(),
