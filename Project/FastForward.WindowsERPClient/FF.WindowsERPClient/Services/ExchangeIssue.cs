...
{
    public partial class ExchangeIssue : FF.WindowsERPClient.Base
    {
        ...
        private Int32 _isAlwPromo = 0;
        private Int32 _isAlwBB = 0;
            ...
            else
            {
                ...
                else
                {
                    ...
                    foreach (DataRow _r in _invoiceitem.Rows)
                    {
                        ...
                        item.Sad_itm_line = _r.Field<Int32>("Grad_line");
        ...
        private void LoadFromRequestService()
        {
            ...
            else
            {
                ...
                //else
                {
                    ...
                    lblCreditValue.Text = FormatToCurrency(Convert.ToString(_oldtotalvalue));
        ...
        private void dgvPendings_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgvPendings.RowCount > 0)
            {
                ...
                _isAlwPromo = Convert.ToInt32(dgvPendings.Rows[e.RowIndex].Cells["GRAH_ALW_PRO"].Value);
                _isAlwBB = Convert.ToInt32(dgvPendings.Rows[e.RowIndex].Cells["GRAH_RCV_BUYB"].Value);


                // Nadeeka 10-06-2015
                if (Convert.ToString(dgvPendings.Rows[e.RowIndex].Cells["col_SubType"].Value) == "SERVICE_APP" || Convert.ToString(dgvPendings.Rows[e.RowIndex].Cells["col_SubType"].Value) == "SERVICE" || Convert.ToString(dgvPendings.Rows[e.RowIndex].Cells["col_SubType"].Value) == "EXCHANGE")
                {
            ...
            try
            {
                ...
                if (_saleType == "HS" && _isAccClosed == false)//Added _isAccClosed == false Sanjeewa 2016-02-19
                {
                    ...
                    foreach (InvoiceItem _ser in _invoiceItemList)
                    {
                        ...
                        _ser.Sad_do_qty = 0;
                        foreach (ReptPickSerials _ser1 in _doitemserials) //Sanjeewa 2016-05-18
                        {
                            _ser.Sad_do_qty = _doitemserials.Where(x => (x.Tus_itm_cd == _ser1.Tus_itm_cd)).Sum(k => k.Tus_qty);
                        }
                    }
        ...
        private void AddItem(bool _isPromotion, string _originalItem)
        {
            try
            {
                ...
                if (_isCombineAdding == false)
                {
                    ...
                    {
                        //if (_saleType == "HS")        //kapila 5/5/2016
                        //{
