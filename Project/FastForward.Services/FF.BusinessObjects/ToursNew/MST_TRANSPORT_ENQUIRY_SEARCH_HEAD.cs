...
{
    public class MST_TRANSPORT_ENQUIRY_SEARCH_HEAD
    {
        ...
        public static MST_TRANSPORT_ENQUIRY_SEARCH_HEAD Converter(DataRow row)
        {
            return new MST_TRANSPORT_ENQUIRY_SEARCH_HEAD
            {
