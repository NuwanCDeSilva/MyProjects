...
namespace FF.BusinessObjects
{
    public class PurchaseOrderDetail : MasterItem
    {
        ...
        private string _pod_qt_supply;
        private decimal _pod_qty_price;
        ...
        public string Pod_qt_supply { get { return _pod_qt_supply; } set { _pod_qt_supply = value; } }
        public decimal Pod_qty_price { get { return _pod_qty_price; } set { _pod_qty_price = value; } }
        ...
        public static PurchaseOrderDetail ConvertTotal(DataRow row)
        {
            return new PurchaseOrderDetail
            {
                ...
                Pod_qt_supply = row["pod_qt_supply"] == DBNull.Value ? string.Empty : row["pod_qt_supply"].ToString(),
                Pod_qty_price = row["pod_qty_price"] == DBNull.Value ? 0 : Convert.ToDecimal(row["pod_qty_price"])
            };
        }
