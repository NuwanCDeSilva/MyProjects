<%@ Page Title="" Language="C#" MasterPageFile="~/View/AdminSite.Master" AutoEventWireup="true" CodeBehind="AssetParameters.aspx.cs" Inherits="FastForward.SCMWeb.View.MasterFiles.AssetManagemenr.AssetMaster" %>
                ...
                <div class="col-sm-12 ">
                    <div class="bs-example">
                        <ul class="nav nav-tabs" id="myTab">
                            <li class="active"><a href="#ItemCategorization" data-toggle="tab">Asset Categorization</a></li>
                            <li onclick="document.getElementById('<%= lbtnBrand.ClientID %>').click();"><a href="#ItemBrand" data-toggle="tab">Asset Brand</a></li>
                            <li onclick="document.getElementById('<%= lbtnUOM.ClientID %>').click();"><a href="#ItemUOM" data-toggle="tab">Asset UOM </a></li>
                            <li onclick="document.getElementById('<%= lbtnColor.ClientID %>').click();"><a href="#ItemColor" data-toggle="tab">Asset Color</a></li>
                            <li><a href="#AssetParameters" data-toggle="tab">Asset Parameter</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-12 ">
                        <div class="tab-content">
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="col-sm-4">
                                                            <div class="row">
                                                                <div class="panel panel-default">
                                                                    <div class="panel-heading paddingtopbottom0">Category level 01</div>
                                                                </div>
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="col-sm-4">
                                                            <div class="row">
                                                                <div class="panel panel-default">
                                                                    <div class="panel-heading paddingtopbottom0">Category level 02</div>
                                                                </div>
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="col-sm-4">
                                                            <div class="row">
                                                                <div class="panel panel-default">
                                                                    <div class="panel-heading paddingtopbottom0">Category level 03</div>
                                                                </div>
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="col-sm-4">
                                                            <div class="row">
                                                                <div class="panel panel-default">
                                                                    <div class="panel-heading paddingtopbottom0">Category level 04</div>
                                                                </div>
                            ...
                            <div class="tab-pane" id="AssetParameters">
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="col-sm-7">
                                                            <div class="row">
                                                                <div class="panel panel-default">
                                                                    <div class="panel-heading paddingtopbottom0">Asset Parameters Level 01</div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <asp:TextBox runat="server" Style="text-transform: uppercase"  MaxLength="15" ID="AssetCat01TextBox" AutoPostBack="true" CausesValidation="false" CssClass="form-control" OnTextChanged="Assetcat01_TextChanged"></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                        <asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="false" OnClick="lbtnCate1_asset_Click">
                                                                    <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
                                                                        </asp:LinkButton>
                                                                    </div>
                                                                   <%-- <div class="col-sm-2 labelText1">
                                                                    ...
                                                                    <div class="col-sm-1">
                                                                        <asp:CheckBox ID="CheckBox1" runat="server" Width="5px"></asp:CheckBox>
                                                                    </div>--%>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <asp:TextBox runat="server" ID="AssetCat01DesTextBox" CausesValidation="false" CssClass="form-control" MaxLength="100"></asp:TextBox>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <%-- <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                        <asp:LinkButton ID="LinkButton5" runat="server" CausesValidation="false" OnClick="lbtnSave1_Click">
                                                                    <span class="glyphicon glyphicon-saved" aria-hidden="true"></span>Save
                                                                        </asp:LinkButton>
                                                                    </div>
                                                                    <div class="col-sm-1 labelText1">
                                                                    ...
                                                                    <div class="col-sm-3 paddingLeft0 paddingRight0">
                                                                        <asp:LinkButton ID="LinkButton6" runat="server" CausesValidation="false" OnClick="lbtnClear1_Click" OnClientClick="ClearConfirm()">
                                                                    <span class="glyphicon glyphicon-refresh" aria-hidden="true"></span>Clear
                                                                        </asp:LinkButton>
                                                                    </div>
                                                                    <div class="col-sm-3 paddingLeft0 paddingRight0">
                                                                        <asp:LinkButton ID="LinkButton7" Visible="false" runat="server" CausesValidation="false" OnClick="lbtnDeletecat1_Click" OnClientClick="DeleteConfirm()">
                                                                    <span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Delete
                                                                        </asp:LinkButton>
                                                                    </div>--%>
                                                                </div>
                                                        ...
                                                        <div class="col-sm-5">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12 ">
                                                                    <div class="panel-body  panelscollbar height85 paddingtopbottom0">
                                                                        <asp:GridView ID="GridView1" ShowHeader="true" CssClass="table table-hover table-striped" runat="server" GridLines="None" ShowHeaderWhenEmpty="True"
                                                                            EmptyDataText="No data found..." AutoGenerateColumns="False">
                                                                            <Columns>
                                                                                <asp:TemplateField HeaderText="" Visible="false">
                                                                                    <HeaderTemplate>
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="col-sm-6">
                                                            <div class="row">
                                                                <div class="panel panel-default">
                                                                    <div class="panel-heading paddingtopbottom0">Asset Parameters Level 02</div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <asp:TextBox runat="server" MaxLength="20" Style="text-transform: uppercase" ID="AssetCat02TextBox" AutoPostBack="true" CausesValidation="false" CssClass="form-control" OnTextChanged="AssetTextCate2_TextChanged"></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-sm-4 paddingLeft0 paddingRight0">
                                                                        <asp:LinkButton ID="LinkButton9" runat="server" CausesValidation="false" OnClick="lbtnCate2_Asset_Click">
                                                                    <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
                                                                        </asp:LinkButton>
                                                                    </div>
                                                                   <%-- <div class="col-sm-2 labelText1">
                                                                    ...
                                                                    <div class="col-sm-1">
                                                                        <asp:CheckBox ID="CheckBox2" runat="server" Width="5px"></asp:CheckBox>
                                                                    </div>--%>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <asp:TextBox runat="server" ID="AssetCat02DesTextBox" CausesValidation="false" CssClass="form-control" MaxLength="100"></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                        <asp:LinkButton ID="LinkButton10" runat="server" Visible="false" CausesValidation="false" OnClick="lbtnAddCate2_Click">
                                                                    <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                                                                        </asp:LinkButton>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-sm-4 paddingLeft0 paddingRight0 paddingLeft0 floatRight">
                                                            <asp:LinkButton ID="LinkButton20" runat="server" CausesValidation="false" OnClick="lbtnSaveDep_Click">
                                                                    <span class="glyphicon glyphicon-saved" style="font-size:20px!important"aria-hidden="true"></span>Save
                                                            </asp:LinkButton>
                                                        </div>
                                                            </div>
                                                        </div>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel11" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 ">
                                                <div class="panel-body  panelscollbar height200 paddingtopbottom0">
                                                    <div class="row">
                                                        <div class="col-sm-2 labelText1">
                                                            <p>Depreciation Method</p>
                                                        </div>
                                                        <div class="col-sm-9">
                                                            <asp:DropDownList ID="DepriciationDropDownList" runat="server" class="form-control"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <br />
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4">
                                                           <asp:DropDownList ID="BaseDropDownList" runat="server" class="form-control" OnSelectedIndexChanged="basedropdownlistChange" AutoPostBack="true"></asp:DropDownList>
                                                        </div>
                                                        <div class="col-sm-2 labelText1" id="depRateDiv" runat="server">
                                                            Useful Life 
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <asp:TextBox runat="server" ID="DepricationValue" AutoPostBack="true" CausesValidation="false" CssClass="form-control" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                     <div class="row">
                                                        <div class="col-sm-2 labelText1">
                                                        ...
                                                        <div class="col-sm-4">
                                                           <asp:DropDownList ID="DisposalOrmarkDropDownList" runat="server" class="form-control"></asp:DropDownList>
                                                        </div>
                                                        <div class="col-sm-2 labelText1">
                                                            Status
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <asp:DropDownList ID="StatusDropDownList" runat="server" class="form-control"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-3 labelText1 ">
                                                        ...
                                                        <div class="col-sm-3 paddingLeft0 paddingRight0">
                                                            <asp:LinkButton ID="LinkButton21" runat="server" Visible="false" CausesValidation="false" OnClick="lbtnClear2_Click" OnClientClick="ClearConfirm()">
                                                                    <span class="glyphicon glyphicon-refresh" aria-hidden="true"></span>Clear
                                                            </asp:LinkButton>
                                                        </div>
                                                        <div class="col-sm-3 paddingLeft0 paddingRight0">
                                                            <asp:LinkButton ID="LinkButton22" Visible="false" runat="server" CausesValidation="false" OnClick="lbtnDeletecat2_Click" OnClientClick="DeleteConfirm()">
                                                                    <span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Delete
                                                            </asp:LinkButton>
                                                        </div>
                                                        <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                            <asp:LinkButton ID="LinkButton3" runat="server" CausesValidation="false" OnClick="AddAssetToGrid_Click">
                                                                    <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                                                            </asp:LinkButton>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 ">
                                            <div class="panel-body  panelscollbar height300 paddingtopbottom0">
                                                <asp:GridView ID="GridViewAssetParameters" ShowHeader="true" CssClass="table table-hover table-striped" runat="server" GridLines="None" ShowHeaderWhenEmpty="True"
                                                    EmptyDataText="No data found..." AutoGenerateColumns="False">
                                                    <Columns>
                                                        <%-- <asp:TemplateField HeaderText="" Visible="false">
                                                                <HeaderTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="#">
                                                                            <ItemTemplate>
                                                                                <asp:LinkButton ID="lbtnDetaltecost" CausesValidation="false"  runat="server" OnClick="lbtndepDelete_Click" OnClientClick="DeleteConfirm()">
                                                        ...
                                                        <asp:TemplateField HeaderText="Dep.Method">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_map_dep_mth" runat="server" Text='<%# Bind("map_dep_mth") %>' Width="50px"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Cat 01">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_map_cat1" runat="server" Text='<%# Bind("map_cat1") %>' Width="60px"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Cat 02">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_map_cat2" runat="server" Text='<%# Bind("map_cat2") %>' Width="60px"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Dep.Base">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_map_dep_base" runat="server" Text='<%# Bind("map_dep_base") %>' Width="30px"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Value">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_map_dep_val" runat="server" Text='<%# Bind("map_dep_val") %>' Width="50px"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Status">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_map_stus" runat="server" Text='<%# Bind("map_stus") %>' Width="20px"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Disposal">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lbl_map_dis" runat="server" Text='<%# Bind("map_dis") %>' Width="20px"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <%--<asp:TemplateField HeaderText="Active">
                                                                <ItemTemplate>
