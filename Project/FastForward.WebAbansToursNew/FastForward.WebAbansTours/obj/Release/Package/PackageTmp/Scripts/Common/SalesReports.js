jQuery(document).ready(function () {
    ...
    jQuery(".btn-sls-rpt-down").click(function (evt) {
                    ...
                    if (result.profCen.length > 0) {
                        for (i = 0; i < result.profCen.length; i++) {
                            jQuery('.profcen-display-tbl').append('<tr class="new-row">' +
                                    '<td class="chk-prof-cen-data">' + '<input class="profit-centers" type="checkbox" name="selectedprofcen[]" value="' + result.profCen[i] + '">' + '</td>' +
