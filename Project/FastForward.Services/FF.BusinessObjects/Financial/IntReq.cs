...
public Int32 ITR_EXG_RATE   { get; set; } 
...
public static IntReq Converter(DataRow row)  
{ 
return new IntReq 
{ 
...
ITR_EXG_RATE = row["ITR_EXG_RATE"] == DBNull.Value ? 0 : Convert.ToInt32(row["ITR_EXG_RATE"].ToString()), 
