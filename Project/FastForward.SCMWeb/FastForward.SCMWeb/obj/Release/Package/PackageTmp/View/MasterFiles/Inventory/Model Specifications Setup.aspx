<%@ Page Title="" Language="C#" MasterPageFile="~/View/AdminSite.Master" AutoEventWireup="true" CodeBehind="Model Specifications Setup.aspx.cs" Inherits="FastForward.SCMWeb.View.MasterFiles.Inventory.Model_Specifications_Setup" %>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:DataList ID="DataList2" CssClass="table table-condensed table-condensed" runat="server" Width="200px">
                                                                                            <ItemTemplate>
                                                                                                ...
                                                                                                <%--<asp:Label ID="defaultItem" runat="server"  Visible= '<%# _modelDetails.Count == 0 %>' Text="No items found" />--%>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <asp:DataList ID="DataList3" CssClass="table table-responsive table-responsive width525" runat="server">
                                                                                            ...
                                                                                            <ItemTemplate>
                                                                                                <asp:TextBox ID="txtCategorytypeDes" CssClass="form-control" Text='<%# Eval("MCT_DEF") %>' runat="server" TextMode="MultiLine"></asp:TextBox>
                                                            ...
                                                            <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                                                <ContentTemplate>
                                                                    <table>
                                                                        <tr>
                                                                            <td>
                                                                                <asp:TextBox AutoPostBack="true" runat="server" Width="525px" ID="TextBox1" CausesValidation="false" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </ContentTemplate>
                                                                            ...
                                                                            <div class="panel panel-default">
                                                                                <div class="panel-body">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                                            <asp:TextBox AutoPostBack="true" runat="server" Width="525px" ID="txtImgRemark" CausesValidation="false" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="panel panel-default">
                                                                                <div class="panel-body">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                                            <asp:TextBox AutoPostBack="true" runat="server" Width="525px" ID="txtVideoRemark" CausesValidation="false" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-sm-12">
                                                                                    <div class="col-sm-10 padding0">
                                                                                        <asp:TextBox ID="txtUrl" placeholder="URL Link" CssClass="form-control" runat="server" Width="300" Text="" />
                                                                                    </div>
                                                                                    <div class="col-sm-2 padding0">
                                                                                        <asp:LinkButton ID="lbtnaddproductionline" runat="server" TabIndex="103" CausesValidation="false" OnClick="btnAdd_Click">
