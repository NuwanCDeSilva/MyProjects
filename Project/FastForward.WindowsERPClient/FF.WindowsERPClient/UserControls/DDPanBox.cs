...
namespace DDPanBox
{
    internal class DDPanBox : Control
    {
        ...
        private bool dragging = false; //Tells us if our image has been clicked on.
        private Point start = new Point(); //Keep initial click for accurate panning.
        ...
        private void panBox_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void panBox_MouseMove(object sender, MouseEventArgs e)
        {
            if (dragging)
            {
        ...
        private void panBox_MouseUp(object sender, MouseEventArgs e)
        {
            dragging = false;
            Cursor = Cursors.Default;
        }

        private void panBox_Resize(object sender, EventArgs e)
        {
            if (_Image != null)
            {
                if (zoom)
        ...
        public void zoomin()
        {
            ...
            DrawRect = new Rectangle(DrawRect.Location.X, DrawRect.Location.Y, ClientRectangle.Width + zoomSize, ClientRectangle.Height + zoomSize);
            this.Refresh();
        }
