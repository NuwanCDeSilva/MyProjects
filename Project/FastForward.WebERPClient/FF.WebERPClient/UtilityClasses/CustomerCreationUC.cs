...
namespace FF.WebERPClient
{
    public class CustomerCreationUC : BasePage
    {
        ...
        public Int32 UpdateCustomer(MasterBusinessEntity _businessEntity, Decimal newCredLimit, List<MasterBusinessEntityInfo> bisInfo)
        {
           // _businessEntity.Mbe_com = GlbUserComCode;
           // _businessEntity.Mbe_cre_by = GlbUserName;
           // _businessEntity.Mbe_cre_pc = GlbUserDefProf;

            Int32 effect = CHNLSVC.Sales.UpdateBusinessEntityProfile(_businessEntity, GlbUserName, DateTime.Today.Date, newCredLimit, bisInfo);
            return effect;
