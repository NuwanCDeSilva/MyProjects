...
namespace FF.BusinessObjects
{
    ...
    /// Warranty Sub Detail
    /// </summary>
    public class InventoryWarrantySubDetail : MasterItem
    {
        ...
        private decimal _irsms_qty;
        private string _irsms_itm_stus_text;
        #endregion
        ...
        //Tharaka 2015-02-11
        public decimal Irsms_qty { get { return _irsms_qty; } set { _irsms_qty = value; } }
        public string Irsms_itm_stus_text { get { return _irsms_itm_stus_text; } set { _irsms_itm_stus_text = value; } }
        ...
        public static InventoryWarrantySubDetail ConvertTotal(DataRow row)
        {
            return new InventoryWarrantySubDetail
            {
                ...
                Irsms_qty = row["IRSMS_QTY"] == DBNull.Value ? 0 : Convert.ToDecimal(row["IRSMS_QTY"])
            };
        }

        //Add by Chamal 28/05/2013
        public static InventoryWarrantySubDetail Converter(DataRow row)
        {
            return new InventoryWarrantySubDetail
            {
                Irsms_act = row["IRSMS_ACT"] == DBNull.Value ? false : Convert.ToBoolean(row["IRSMS_ACT"]),
                ...
                Irsms_itm_stus_text = row["MIS_DESC"] == DBNull.Value ? string.Empty : row["MIS_DESC"].ToString()
            };
        }
    }
}
