...
{
    public class STNBaseDAL
    {

        //  Task            : Data Access Layer for the STN
        //  Developed By    : Kapila
        //  Competed On     : 20/6/2013
        ...
        {
            return System.Configuration.ConfigurationManager.ConnectionStrings["ConnSTN"].ConnectionString;
        }
