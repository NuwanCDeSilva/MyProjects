<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceivableMovementReportSummaryPrint.aspx.cs" Inherits="FF.WebERPClient.Reports_Module.Sales_Rep.ReceivableMovementReportSummaryPrint" %>
...
<body >
    ...
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="ReceivableMovementReport.rpt">
        </Report>
