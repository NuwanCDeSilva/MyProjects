<%@ Page Title="" Language="C#" MasterPageFile="~/View/AdminSite.Master" AutoEventWireup="true" CodeBehind="Pur_Rep.aspx.cs" Inherits="FastForward.SCMWeb.View.Reports.Purchasing.Pur_Rep" %>
                        ...
                        <div class="col-sm-12 col-md-12 panel panel-default">
                            <div class="row buttonRow" id="HederBtn">
                                <div class="col-sm-12 col-md-12">
                                    <div class="col-md-10">
                                        <h1 style="font-size: small; margin-top: 2px">Purchasing Report</h1>
                                    </div>
                                        ...
                                        <div class="col-sm-12 col-md-12 panel panel-default padding0 height230 " style="height: 634px">
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12">
                                                    <div class="col-sm-1 col-md-1 height20" style="padding-left: 5px; padding-right: 3px;">
                                                        <asp:RadioButton ID="rad01" GroupName="grpReport" OnCheckedChanged="rad01_CheckedChanged" runat="server" />
                                                    </div>
                                                    <div class="col-sm-11 col-md-11 labelText1" style="padding-left: 3px; padding-right: 3px">
                                                        <asp:Label ID="Label1" runat="server" Text="LO PO Details Report"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                            <%--<div class="row">
                                            ...
                                            <%-- <div class="row">
                                                <div class="col-sm-12 col-md-12">
                                                    ...
                                                    <div class="col-sm-11 col-md-11 labelText1" style="padding-left: 3px; padding-right: 3px">
                                                        <asp:Label ID="Label10" runat="server" Text="Age Report (Items)"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>--%>
                                            <%--<div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12">
                                                    ...
                                                    <div class="col-sm-11 col-md-11 labelText1" style="padding-left: 3px; padding-right: 3px">
                                                        <asp:Label ID="Label12" runat="server" Text="PO Detail"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12">
                                                    ...
                                                    <div class="col-sm-11 col-md-11 labelText1" style="padding-left: 3px; padding-right: 3px">
                                                        <asp:Label ID="Label17" runat="server" Text="Purchase Return Details"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12">
                                                    ...
                                                    <div class="col-sm-11 col-md-11 labelText1" style="padding-left: 3px; padding-right: 3px">
                                                        <asp:Label ID="Label2" runat="server" Text="Item Wise Stationery Req Report"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12">
                                                    <div class="col-sm-1 col-md-1 height20" style="padding-left: 5px; padding-right: 3px">
                                                        <asp:RadioButton ID="rad28" GroupName="grpReport" runat="server" AutoPostBack="True" OnCheckedChanged="rad28_CheckedChanged" />
                                                    </div>
                                                    <div class="col-sm-11 col-md-11 labelText1" style="padding-left: 3px; padding-right: 3px">
                                                        <asp:Label ID="Label4" runat="server" Text="Dept wise Item Requirements Report"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12">
                                                    <div class="col-sm-1 col-md-1 height20" style="padding-left: 5px; padding-right: 3px">
                                                        <asp:RadioButton ID="rad29" GroupName="grpReport" runat="server" AutoPostBack="True" OnCheckedChanged="rad29_CheckedChanged" />
                                                    </div>
                                                    <div class="col-sm-11 col-md-11 labelText1" style="padding-left: 3px; padding-right: 3px">
                                                        <asp:Label ID="Label5" runat="server" Text="Supplier Prices"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    ...
                                                    <div class="col-sm-11 col-md-11 labelText1" style="padding-left: 3px; padding-right: 3px">
                                                        <asp:Label ID="Label22" runat="server" Text="Current Age Analysis Report"></asp:Label>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-12">
                                                    <div class="col-sm-1 col-md-1 height20" style="padding-left: 5px; padding-right: 3px">
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    <div class="col-sm-1 col-md-1 height20" style="padding-left: 5px; padding-right: 3px">
                                                        <asp:RadioButton ID="rad23" GroupName="grpReport" runat="server" />
                                                    </div>
                                                    <div class="col-sm-11 col-md-11 labelText1" style="padding-left: 3px; padding-right: 3px">
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    <div class="col-sm-1 col-md-1 height20" style="padding-left: 5px; padding-right: 3px">
                                                        <asp:RadioButton ID="rad24" GroupName="grpReport" runat="server" />
                                                    </div>
                                                    <div class="col-sm-11 col-md-11 labelText1" style="padding-left: 3px; padding-right: 3px">
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    <div class="col-sm-1 col-md-1 height20" style="padding-left: 5px; padding-right: 3px">
                                                        <asp:RadioButton ID="rad25" GroupName="grpReport" runat="server" />
                                                    </div>
                                                    <div class="col-sm-11 col-md-11 labelText1" style="padding-left: 3px; padding-right: 3px">
                                                        <asp:Label ID="Label26" runat="server" Text="Item Seril Report"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>--%>
                                        </div>
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    ...
                                                                                    <span class="glyphicon glyphicon-calendar" aria-hidden="true"  ></span>
                                                                                                        ...
                                                                                                        <div class="col-sm-4 col-md-4" style="padding-left: 2px; padding-right: 2px;">
                                                                                                            <asp:TextBox runat="server" placeholder="DD/MMM/yyyy" ID="txtToDate" CssClass="form-control" OnTextChanged="txtToDate_TextChanged" />
                                                                                                        </div>
                                                                                                        <div class="col-sm-1 col-md-1 paddingLeft0">
                                                                                    ...
                                                                                    <span class="glyphicon glyphicon-calendar" aria-hidden="true"  ></span>
                                                                                                ...
                                                                                                <div class="row" style="padding-top: 3px;">
                                                                                                    <div class="col-sm-12 col-md-12">
                                                                                                        <div class="col-sm-3 col-md-1 labelText1 padding0">
                                                                                                            <asp:Label runat="server">As At</asp:Label>
                                                                                                        </div>
                                                                                                        <div class="col-sm-4 col-md-4 padding0" style="padding-left: 5px; padding-right: 2px;">
                                                                                                        ...
                                                                                                        <div class="col-sm-3 col-md-1 labelText1 padding0">
                                                                                                            <asp:Label runat="server">Expiry</asp:Label>
                                                                                                        </div>
                                                                                                        <div class="col-sm-4 col-md-4 padding0" style="padding-left: 5px; padding-right: 2px;">
