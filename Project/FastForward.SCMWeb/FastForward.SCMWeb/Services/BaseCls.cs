...
namespace FastForward.SCMWeb
{
    ...
    public static class BaseCls
    {
        ...
        public static MasterLocation GlbMasterLocation = null; // Tharaka 2015-12-08
        ...
        public static string GlbReportCompName = string.Empty;      //kapila 23/12/2015
        public static string GlbReportCompanies = string.Empty;     //kapila 5/2/2016
        ...
        public static string GlbReportSINo = string.Empty;
        public static string GlbReportLCNo = string.Empty;
        public static string GlbReportEntryNo = string.Empty;
        public static string GlbReportBLNo = string.Empty;
        public static string GlbReportToBondNo = string.Empty;
        public static string GlbReportBank = string.Empty;
        public static string GlbReportAgent = string.Empty;
        public static string GlbReportDocCat = string.Empty;
        public static string GlbReportCountry = string.Empty;
        public static string GlbReportPort = string.Empty;
        ...
        public static string GlbReportWithGIT = "N";
        public static string GlbReportWithJob = "N";
        ...
        public static Int32 GlbReportFromAge = 0;       //kapila 28/12/2015
        public static Int32 GlbReportToAge = 0;
        ...
        //Kelum : DataTable Convert to Generic List : 2016-May-06
