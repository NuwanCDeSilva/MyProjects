<%@ Page Title="" Language="C#" MasterPageFile="~/View/AdminSite.Master" AutoEventWireup="true" CodeBehind="SalesInvoiceOld.aspx.cs" Inherits="FastForward.SCMWeb.View.Transaction.Sales.SalesInvoice.SalesInvoiceOld" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
            ...
            <div class="panel-body paddingbottom0">
                <div class="col-sm-12">
                    <div class="panel panel-default paneldefaultheightorderplan salesinvfirstpnl" id="1s">
                        ...
                        <asp:UpdateProgress ID="UpdateProgress11" DisplayAfter="1" runat="server" AssociatedUpdatePanelID="upTranMet">
                            <ProgressTemplate>
                                <div class="divWaiting">
                                                            ...
                                                            <asp:UpdatePanel runat="server">
                                                                <ContentTemplate>
                                                                    <div class="col-sm-2 padding0">
                                                                        ...
                                                                        <div class="col-sm-12 padding0">
                                                                            <div class="col-sm-12 padding0">
                                                                                <asp:TextBox ID="txtUnitPrice" runat="server" TabIndex="31" AutoPostBack="true" OnTextChanged="txtUnitPrice_TextChanged" Style="text-align: right"  CssClass="form-control"></asp:TextBox>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-2 padding0">
                                                                        ...
                                                                        <div class="col-sm-3">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-10" style="margin-top: 3px">
                                                                                    <asp:TextBox ID="lblItemModel" runat="server" ForeColor="#A513D0" CssClass="form-control"></asp:TextBox>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-3">
    ...
    <asp:UpdateProgress ID="UpdateProgress7" DisplayAfter="10" runat="server" AssociatedUpdatePanelID="upPnlSerch">
        <ProgressTemplate>
            <div class="divWaiting">
