...
{
    [Serializable]
    public class HpSchemeDetailsLog
    {
        ...
        public static HpSchemeDetailsLog Converter(DataRow row)
        {
            return new HpSchemeDetailsLog
            {
                ...
                Hsd_noof_addrnt = row["HSD_NOOF_ADDRNT"] == DBNull.Value ? 0 : Convert.ToInt16(row["HSD_NOOF_ADDRNT"]),
