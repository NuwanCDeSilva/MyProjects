<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DailyTransSummaryPrint.aspx.cs" Inherits="FF.WebERPClient.Reports_Module.Sales_Rep.DailyTransSummaryPrint" %>
...
<body >
    ...
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="Remitance_Sum.rpt">
        </Report>
