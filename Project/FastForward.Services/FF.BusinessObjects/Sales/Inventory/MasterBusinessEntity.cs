...
namespace FF.BusinessObjects
{
    ...
    public class MasterBusinessEntity
    {
        ...
        public string Mbe_acc_cd
        {
            get { return _mbe_acc_cd; }
            set { _mbe_acc_cd = value; }
        }
        public Boolean Mbe_act
        {
            get { return _mbe_act; }
            set { _mbe_act = value; }
        }
        ...
        {
            get { return _mbe_add1; }
            set { _mbe_add1 = value; }
        }
        public string Mbe_add2
        {
            get { return _mbe_add2; }
            set { _mbe_add2 = value; }
        }
        ...
        {
            get { return _mbe_contact; }
            set { _mbe_contact = value; }
        }
        public string Mbe_country_cd
        {
            get { return _mbe_country_cd; }
            set { _mbe_country_cd = value; }
        }
        public string Mbe_distric_cd
        {
            get { return _mbe_distric_cd; }
            set { _mbe_distric_cd = value; }
        }
        public string Mbe_email
        {
            get { return _mbe_email; }
            set { _mbe_email = value; }
        }
        ...
        public Boolean Mbe_is_suspend
        {
            get { return _mbe_is_suspend; }
            set { _mbe_is_suspend = value; }
        }
        ...
        {
            get { return _mbe_province_cd; }
            set { _mbe_province_cd = value; }
        }
        public string Mbe_sub_tp
        {
            get { return _mbe_sub_tp; }
            set { _mbe_sub_tp = value; }
        }
        ...
        {
            get { return _mbe_town_cd; }
            set { _mbe_town_cd = value; }
        }
