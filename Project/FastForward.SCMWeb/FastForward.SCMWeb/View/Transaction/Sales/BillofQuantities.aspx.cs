...
{
    public partial class Bill_of_Quantities : Base
    {
        ...
        private void UpdateBOQ()
        {
            ...
            //_SatProjectDetails.Add(new SatProjectDetails() { SPD_ACTVE = Convert.ToInt16(boqAct.SelectedValue) });
            _SatProjectHeader.SPH_RMK = txtremark.Text;
            rowsAffected = CHNLSVC.Sales.UpdateBOQHDD(_SatProjectHeader, _SatProjectDetails,null, out _docNo); //UpdateBOQsatProHdr
