...
namespace FastForward.SCMWeb.View.Reports.Sales {
    ...
    public class InvoiceFullPrints : ReportClass {
        
        public InvoiceFullPrints() {
        }
        
        public override string ResourceName {
            get {
                return "InvoiceFullPrints.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "FastForward.SCMWeb.View.Reports.Sales.InvoiceFullPrints.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedInvoiceFullPrints : Component, ICachedReport {
        
        public CachedInvoiceFullPrints() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            InvoiceFullPrints rpt = new InvoiceFullPrints();
            rpt.Site = this.Site;
            return rpt;
        }
