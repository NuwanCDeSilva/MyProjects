...
{
    public partial class CustomerAcknoledgmentPrint : BasePage
    {
        ...
        public void Display()
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(HPCustType)) { CrystalReportSource1.ReportDocument.SetParameterValue("Type", HPCustType); }
