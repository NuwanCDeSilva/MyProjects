  ...
  public  class DELI_SALE_NEW
    {
        ...
        public string PriceCircula { get; set; }
        ...
        public string Recpaytp { get; set; }
        public DateTime TargetFromDate { get; set; }
        public DateTime TargetToDate { get; set; }
        public decimal btu { get; set; }

        public static DELI_SALE_NEW Converter(DataRow row)
        {
            return new DELI_SALE_NEW
            {
                ...
                Do_item_line = row["DO_ITEM_LINE"] == DBNull.Value ? 0 : Convert.ToInt32(row["DO_ITEM_LINE"].ToString()),
                Do_batch_line = row["DO_BATCH_LINE"] == DBNull.Value ? 0 : Convert.ToInt32(row["DO_BATCH_LINE"].ToString()),
                ...
                Cost_amt = row["COST_AMT"] == DBNull.Value ? 0 : Convert.ToDecimal(row["COST_AMT"].ToString()),
                Main_itm = row["MAIN_ITM"] == DBNull.Value ? string.Empty : row["MAIN_ITM"].ToString(),
                Free_itm_cost = row["FREE_ITM_COST"] == DBNull.Value ? 0 : Convert.ToDecimal(row["FREE_ITM_COST"].ToString()),
                ...
                Cash_dir = row["CASH_DIR"] == DBNull.Value ? 0 : Convert.ToInt32(row["CASH_DIR"].ToString()),
                ...
                PriceCircula = row["PriceCircula"] == DBNull.Value ? string.Empty : row["PriceCircula"].ToString(),
