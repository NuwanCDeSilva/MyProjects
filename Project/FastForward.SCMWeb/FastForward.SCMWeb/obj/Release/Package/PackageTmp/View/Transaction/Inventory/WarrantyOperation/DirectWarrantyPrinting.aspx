<%@ Page Title="" Language="C#" MasterPageFile="~/View/AdminSite.Master" AutoEventWireup="true" CodeBehind="DirectWarrantyPrinting.aspx.cs" Inherits="FastForward.SCMWeb.View.Transaction.Inventory.WarrantyOperation.DirectWarrantyPrinting" %>
                                ...
                                <div class="col-sm-12">
                                    <div class="panel panel-default">
                                        <div class="panel panel-heading">
                                            <strong><b>Direct Warranty Print</b></strong>
                                        </div>
                                                                            ...
                                                                            <div class="col-sm-12">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <asp:Panel runat="server" ID="pnlRePrint">
                                                                                         <div class="col-sm-1">
                                                                                        <asp:CheckBox AutoPostBack="true" OnCheckedChanged="chkRePrint_CheckedChanged" Checked="false" Text="" ID="chkRePrint" runat="server" />
                                                                                    </div>
