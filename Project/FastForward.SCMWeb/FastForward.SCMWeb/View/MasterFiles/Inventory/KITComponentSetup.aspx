                                            ...
                                            <div class="panel panel-default " id="y5">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <div class="col-sm-10 paddingLeft0">
                                                                <asp:TextBox runat="server" ID="txtkitcode" AutoPostBack="true" Style="text-transform: uppercase" CausesValidation="false" CssClass="form-control" OnTextChanged="txtkitcode_TextChanged"></asp:TextBox>
                                                            </div>
                                                            <div class="col-sm-1 paddingLeft0">
                                                                <asp:LinkButton ID="LinkButton2" CausesValidation="false" runat="server" OnClick="lbtnkititemcode_Click">
                                                                                <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
                                                                </asp:LinkButton>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-1 padding0">
                                                            <asp:LinkButton ID="LinkButton3" runat="server" TabIndex="103" CausesValidation="false" OnClick="lbtnAddKItItem_Click">
                                                                     <span class="glyphicon glyphicon-plus" style="font-size:20px;"  aria-hidden="true"></span>
                                                            </asp:LinkButton>
                                                        </div>
                                                        <div class="col-sm-6 labelText1 " style="color: red">
                                            <asp:Label runat="server" ID="kitdetadddes"></asp:Label>
                                        </div>
                                                    </div>
                                                    <%--  --%>
