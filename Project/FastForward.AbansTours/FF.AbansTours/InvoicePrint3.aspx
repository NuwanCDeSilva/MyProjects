<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="InvoicePrint3.aspx.cs" Inherits="FF.AbansTours.InvoicePrint3" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
          ...
          <%--  <asp:Button class="btn btn-primary" runat="server" ID="SuperBtn" type="submit" Text="Print View using WebPage"
                Width="189px" Height="32px" BackColor="#6699FF" Visible="true"/>--%>
         ...
         <div id="dvReport">
             <asp:Button  class="btn btn-primary" ID="Button2" runat="server" Text="Print"  Width="203px" Height="32px"  OnClientClick="Print()" />
          <br />  <br />  
<CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="true"
    Height="800px" Width="1000px" BestFitPage="False" ToolPanelView="None" />
</div>
<br />
                ...
                <div class="haeading">
                  ...
                  <asp:Button ID="btnprintD" runat="server" BackColor="Brown" class="btn btn-primary"
                    ...
                    <asp:Button ID="btnprintL" runat="server" BackColor="Brown" class="btn btn-primary"
                        Height="32px" Text="Print" type="submit" Visible="true" 
                        Width="189px" onclick="btnprintL_Click"
                         />
                    <br />
                    <br />
                    <br />
