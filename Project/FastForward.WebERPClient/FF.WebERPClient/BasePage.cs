...
namespace FF.WebERPClient
{
    public class BasePage : System.Web.UI.Page
    {
        ...
        ChannelOperator channelService = new ChannelOperator();
        ...
        {
            get { return (Session["UserCompanyCode"] != null) ? Session["UserCompanyName"].ToString() : string.Empty; }
        }
        ...
        */
        ...
        {
            BusinessObjects.MasterAutoNumber _masterAutoNumber = CHNLSVC.Inventory.GetAutoNumber(_module, _direction, _startChar, _catType, _catCode, _modifyDate, _year);
            return _masterAutoNumber.Aut_number;

        }
        //written by prabhath on 31/05/2012
        public Int16 UpdateAutoNumber(BusinessObjects.MasterAutoNumber _masterAutoNumber)
        {
