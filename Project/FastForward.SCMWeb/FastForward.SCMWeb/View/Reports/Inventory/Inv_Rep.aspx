                                        ...
                                        <div class="col-sm-12 col-md-12 panel panel-default padding0 height230 " style="height: 634px; overflow: auto;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                 ...
                                                 <div class="col-sm-12 col-md-12">
                                                    <div class="col-sm-1 col-md-1 height20" style="padding-left: 5px; padding-right: 3px">
                                                        <asp:RadioButton AutoPostBack="true" ID="rad60" GroupName="grpReport" runat="server" OnCheckedChanged="rad60_CheckedChanged" />
                                                    </div>
                                                    <div class="col-sm-11 col-md-11 labelText1" style="padding-left: 3px; padding-right: 3px">
                                                        <asp:Label ID="Label60" runat="server" Text="Fixed Assets Depreciation Summery"></asp:Label>
                                                    </div>
                                                </div>

                                                <div class="col-sm-12 col-md-12">
                                                    <div class="col-sm-1 col-md-1 height20" style="padding-left: 5px; padding-right: 3px">
                                                        <asp:RadioButton AutoPostBack="true" ID="rad61" GroupName="grpReport" runat="server" OnCheckedChanged="rad61_CheckedChanged" />
                                                    </div>
                                                    <div class="col-sm-11 col-md-11 labelText1" style="padding-left: 3px; padding-right: 3px">
                                                        <asp:Label ID="Label61" runat="server" Text="Fixed Assets PPNOTE"></asp:Label>
                                                    </div>
                                                </div>

                                                 <div class="col-sm-12 col-md-12">
                                                    <div class="col-sm-1 col-md-1 height20" style="padding-left: 5px; padding-right: 3px">
                                                        <asp:RadioButton AutoPostBack="true" ID="rad62" GroupName="grpReport" runat="server" OnCheckedChanged="rad59_CheckedChanged" />
                                                    </div>
                                                    <div class="col-sm-11 col-md-11 labelText1" style="padding-left: 3px; padding-right: 3px">
                                                        <asp:Label ID="Label62" runat="server" Text="Fixed Assets Disposal"></asp:Label>
                                                    </div>
                                                </div>
