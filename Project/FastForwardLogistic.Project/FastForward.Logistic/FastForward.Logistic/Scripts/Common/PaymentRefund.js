...
jQuery(document).ready(function () {
    ...
    jQuery(".chk-bnk-acc-search").click(function () {
        var headerKeys = Array()
        headerKeys = ["Row", "Id", "Description", "Code"];
        field = "chkBnkAcc";
        var x = new CommonSearch(headerKeys, field);
    });
    ...
    jQuery(".add-price-amount-btn").on("click", function (evt) {
        ...
        {
            setInfoMsg('Invalid amount entered.');
            return;
        }

        if (Number((jQuery("#Sird_settle_amt").val().replace(/\,/g, ""))) < Number((jQuery(".bal-amount-val").html().replace(/\,/g, "")))) {
          
            setInfoMsg("Amount cannot be less than total of selected amount");
            return;
        }
