<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RemitanceDetailsPrint.aspx.cs" Inherits="FF.WebERPClient.Reports_Module.Sales_Rep.RemitanceDetailsPrint" %>
...
<body >
    ...
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="Remitance_Det.rpt">
        </Report>
