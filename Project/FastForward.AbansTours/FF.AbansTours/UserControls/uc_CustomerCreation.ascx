<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_CustomerCreation.ascx.cs"
    Inherits="FF.AbansTours.UserControls.uc_CustomerCreation" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Src="uc_CustCreationExternalDet.ascx" TagName="uc_CustCreationExternalDet"
    TagPrefix="uc1" %>
            ...
            <div style="float: left; width: 100%;">
                <div style="float: left; width: 50%;">
                    ...
                    <div style="float: left; width: 100%;">
                        ...
                        <div style="float: left; width: 49%;">
                            <asp:TextBox ID="txtNicNo" runat="server" CssClass="TextBoxUpper" MaxLength="10"></asp:TextBox>
                        </div>
                    </div>
                    <div style="float: left; width: 100%;">
                        <%--//row--%>
                        ...
                        <div style="float: left; width: 49%;">
                            <asp:TextBox ID="txtPassportNo" runat="server" CssClass="TextBoxUpper" MaxLength="10"></asp:TextBox>
                        </div>
                    </div>
...
<div>
    ...
    <div style="visibility: hidden">
        ...
        <asp:Button ID="btnGetbyCustCD" runat="server" OnClick="btnGetbyCustCD_Click" />
        <asp:Button ID="btnGetbyNIC" runat="server" OnClick="btnGetbyNIC_Click" />
        <asp:Button ID="btnGetbyDL" runat="server" OnClick="btnGetbyDL_Click" />
        <asp:Button ID="btnGetbyPPno" runat="server" OnClick="btnGetbyPPno_Click" />
        <asp:Button ID="btnGetbyBrNo" runat="server" OnClick="btnGetbyBrNo_Click" />
    </div>
    <%--   </div>--%>
</div>
