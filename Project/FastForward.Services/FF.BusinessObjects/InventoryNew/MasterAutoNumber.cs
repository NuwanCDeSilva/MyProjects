...
namespace FF.BusinessObjects
{
    public class MasterAutoNumber 
    {
        ...
        //Add by Lakshan 26Jan2018
        public static MasterAutoNumber CreateNewObject(MasterAutoNumber _obj)
        {
            MasterAutoNumber _newObj = new MasterAutoNumber();
            _newObj.Aut_cate_cd = _obj.Aut_cate_cd;
            _newObj.Aut_cate_tp = _obj.Aut_cate_tp;
            _newObj.Aut_direction = _obj.Aut_direction;
            _newObj.Aut_modify_dt = _obj.Aut_modify_dt;
            _newObj.Aut_moduleid = _obj.Aut_moduleid;
            _newObj.Aut_number = _obj.Aut_number;
            _newObj.Aut_start_char = _obj.Aut_start_char;
            _newObj.Aut_year = _obj.Aut_year;
            return _newObj;
        }
    }
}
