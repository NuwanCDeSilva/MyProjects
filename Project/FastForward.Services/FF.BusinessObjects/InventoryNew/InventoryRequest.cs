...
namespace FF.BusinessObjects
{
    ...
    public class InventoryRequest
    {
        ...
        public DateTime Itr_pda_comp_dt { get; set; }
        public Int32 Itr_pda_comp { get; set; }
        public bool sad_res_line_no_udt { get; set; }

        public RCC Rcc_Details { get; set; } //add by akila 2017/12/28
         ...
         public static InventoryRequest ConverterCusdecEntryRequest(DataRow row)
        {
         ...
         public static InventoryRequest Converter5(DataRow row)
         {
             return new InventoryRequest
             {
                 Itr_act = row["ITR_ACT"] == DBNull.Value ? 0 : Convert.ToInt32(row["ITR_ACT"]),
                 ...
                 Itr_job_line = row["ITR_JOB_LINE"] == DBNull.Value ? 0 : Convert.ToInt32(row["ITR_JOB_LINE"]),
                 Itr_vehi_no = row["itr_vehi_no"] == DBNull.Value ? string.Empty : row["itr_vehi_no"].ToString(),
                 Itr_pda_comp = row["Itr_pda_comp"] == DBNull.Value ? 0: Convert.ToInt32(row["Itr_pda_comp"].ToString()),
                 Itr_pda_comp_dt = row["Itr_pda_comp_dt"] == DBNull.Value ? DateTime.MinValue : Convert.ToDateTime(row["Itr_pda_comp_dt"].ToString())
             };
         }
         public static InventoryRequest Converter2(DataRow row)
         {
             return new InventoryRequest
             {
                 Itr_act = row["ITR_ACT"] == DBNull.Value ? 0 : Convert.ToInt32(row["ITR_ACT"]),
         ...
         public static InventoryRequest ConverterDO(DataRow row)
         {
             return new InventoryRequest
             {
                 Itr_req_no = row["ITR_REQ_NO"] == DBNull.Value ? string.Empty : row["ITR_REQ_NO"].ToString(),
