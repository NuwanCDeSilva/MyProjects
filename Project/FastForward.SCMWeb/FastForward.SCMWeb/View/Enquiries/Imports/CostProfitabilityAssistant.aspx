                            ...
                            <div class="panel-body panelscollbar height120" id="ImportGridPanel" runat="server">
                                <asp:GridView ID="ImportGrid" CssClass="table table-hover table-striped" runat="server" GridLines="None" ShowHeaderWhenEmpty="True" AutoGenerateSelectButton="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Duty Free($)" HeaderStyle-CssClass="column_style_right" ItemStyle-CssClass="data_style_decimal">
                                            <ItemTemplate>
                                                <asp:Label ID="ImpGridDFUSD" runat="server" Text='<%# (Convert.ToDecimal(Eval("DFUSD"))).ToString("N2") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Forecasted Cost" HeaderStyle-CssClass="column_style_right" ItemStyle-CssClass="data_style_decimal">
                                            <ItemTemplate>
                                                <asp:Label ID="ImpGridForeCastedCost" runat="server" Text='<%# (Convert.ToDecimal(Eval("ForeCastedCost"))).ToString("N2") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                ...
                                <div class="col-sm-2">
                                 ...
                                 <div class="col-sm-2">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <asp:Label ID="LabelProj" runat="server" CssClass="Color1 fontWeight900"></asp:Label>
                                        </div>
                                    </div>
                                </div>
                            </div>
