...
{
    public class SalesForecastingHeader
    {
        ...
        public string sfh_type { get; set; }
        public static SalesForecastingHeader Converter(DataRow row)
        {
            return new SalesForecastingHeader
            {
                ...
                sfh_type = row["sfh_type"] == DBNull.Value ? string.Empty : row["sfh_type"].ToString(),
            };
        }
    }
}
