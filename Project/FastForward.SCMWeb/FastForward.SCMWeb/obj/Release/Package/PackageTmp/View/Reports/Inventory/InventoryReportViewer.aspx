<%@ Page Title="" Language="C#" MasterPageFile="~/View/AdminSite.Master" AutoEventWireup="true" CodeBehind="InventoryReportViewer.aspx.cs" Inherits="FastForward.SCMWeb.View.Reports.Inventory.InventoryReportViewer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
     <input type="submit" value="Print" class="btn btn-default btn-default-style btn-print-repot" />
    <div class="panel panel-default marginLeftRight5 height525">
        <div class="panel-body">

            <div class="panel panel-default height500">

                 <CR:CrystalReportViewer ID="CVInventory" runat="server" AutoDataBind="true" HasExportButton="True" HasCrystalLogo="False" HasRefreshButton="False" HasDrillUpButton="False"/>
            <br />
