...
namespace BarcodeLib
{
    ...
    public  class Barcode: IDisposable
    {
       ...
       // private Font _LabelFont = new Font("Microsoft Sans Serif", 10, FontStyle.Regular);
        private Font _LabelFont = new Font("Arial", 7, FontStyle.Regular);
        ...
        private int _leftsidepadding = 0;
        private int _Bottomsidepadding = 0;
        #endregion
        ...
        public Int32 Leftsidepadding
        {
            get { return _leftsidepadding; }
            set { _leftsidepadding = value; }
        }
        public Int32 Bottomsidepadding
        {
            get { return _Bottomsidepadding; }
            set { _Bottomsidepadding = value; }
        }
                ...
                default:
                    {
                        ...
                        //draw image
                        int pos = 0;
                        int halfBarWidth = (int)(iBarWidth * Leftsidepadding);//0.5 rukshan
                                    ...
                                    while (pos < Encoded_Value.Length)
                                    {
                                        if (this.Encoded_Type == TYPE.PostNet)
                                        {
                                            ...
                                            if (Encoded_Value[pos] == '0')
                                               // g.DrawLine(pen, new Point(pos * iBarWidth + shiftAdjustment + halfBarWidth , Height+80), new Point(pos * iBarWidth + shiftAdjustment + halfBarWidth, Height / 2));
                                                g.DrawLine(pen, new Point(pos * iBarWidth + shiftAdjustment + halfBarWidth, Height + Newvalue), new Point(pos * iBarWidth + shiftAdjustment + halfBarWidth, Height / 2));
                                            else
                                               // g.DrawLine(pen, new Point(pos * iBarWidth + shiftAdjustment + halfBarWidth, Height+80), new Point(pos * iBarWidth + shiftAdjustment + halfBarWidth, 0));
                                                g.DrawLine(pen, new Point(pos * iBarWidth + shiftAdjustment + halfBarWidth, Height + Newvalue), new Point(pos * iBarWidth + shiftAdjustment + halfBarWidth, 0));
                                        }//if
                                        else
                                        {
                                            if (Encoded_Value[pos] == '1')
                                               //Rukshan //g.DrawLine(pen, new Point(pos * iBarWidth + shiftAdjustment + halfBarWidth, 0), new Point(pos * iBarWidth + shiftAdjustment + halfBarWidth, Height));
                                               // g.DrawLine(pen, new Point(pos * iBarWidth + shiftAdjustment + halfBarWidth, +80), new Point(pos * iBarWidth + shiftAdjustment + halfBarWidth, Height));
                                                g.DrawLine(pen, new Point(pos * iBarWidth + shiftAdjustment + halfBarWidth, +Newvalue), new Point(pos * iBarWidth + shiftAdjustment + halfBarWidth, Height));
                                        }
                                        pos++;
                                    }//while
                                }//using
        ...
        private Image Label_Generic(Image img)
        {
            try
            {
                ...
                using (Graphics g = Graphics.FromImage(img))
                {
                    ...
                    switch (LabelPosition)
                    {
                        case LabelPositions.BOTTOMCENTER:
                           ...
                           // LabelY = img.Height - (font.Height);
                            LabelY = img.Height - (font.Height) - Bottomsidepadding;
                            f.Alignment = StringAlignment.Center;
                            break;
                    ...
                    g.FillRectangle(new SolidBrush(BackColor), new RectangleF((float)0, (float)LabelY, (float)img.Width, (float)font.Height+20));
