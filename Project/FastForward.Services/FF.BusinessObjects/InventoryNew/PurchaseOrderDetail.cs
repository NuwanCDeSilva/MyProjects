...
namespace FF.BusinessObjects
{
    ...
    public class PurchaseOrderDetail : MasterItem
    {
        ...
        private string _pod_qt_supp;
        private decimal _pod_qt_price;

        private decimal _claim_rate;
        private decimal _claim_amt;
        private decimal _claim_price;
        private Int32 Pod_warr_period;
        private string Pod_warr_remrk ;

        #endregion
        public decimal Claim_rate { get { return _claim_rate; } set { _claim_rate = value; } }
        public decimal Claim_amt { get { return _claim_amt; } set { _claim_amt = value; } }
        public decimal Claim_price { get { return _claim_price; } set { _claim_price = value; } }
        ...
        public string Pod_qt_supp { get { return _pod_qt_supp; } set { _pod_qt_supp = value; } }
        public decimal Pod_qt_price { get { return _pod_qt_price; } set { _pod_qt_price = value; } }
        public string Pod_req_no{ get; set; }
        public string Pod_warr_per { get; set; }
        public string Pod_warr_rmk { get; set; }
