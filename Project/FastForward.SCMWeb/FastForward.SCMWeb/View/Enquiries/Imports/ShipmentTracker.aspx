                                                ...
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-sm-12 labelText1 padding0">
                                                                    <div class="col-sm-4 labelText1">Expected Clearance</div>
                                                            <div class="col-sm-1"></div>
                                                        <div class="col-sm-1" style="padding-left:3px; padding-right:0px;">
                                                                    <asp:CheckBox ID="CheckBoxExcepcted" runat="server" AutoPostBack="true" Enabled="false" Checked="false" ValidationGroup="g" 
                                                                       OnCheckedChanged="CheckBoxexpec_CheckedChanged" />
                                                                </div>
                                                            <div class="col-sm-4 labelText1">Pending Clearance</div>
                                                            <div class="col-sm-1"></div>
                                                            <div class="col-sm-1" style="padding-left:3px; padding-right:0px;">
                                                                    <asp:CheckBox ID="CheckBoxPendeing" runat="server" AutoPostBack="true" Checked="false" ValidationGroup="g" 
                                                                      OnCheckedChanged="CheckBoxpending_CheckedChanged"  />
                                                                </div>
                                                            </div>
                                                    </div>
                                                     <div class="row">
                                                        <div class="col-sm-12 labelText1 padding0">
                                                                    <div class="col-sm-4 labelText1">Actual Clearance</div>
                                                            <div class="col-sm-1"></div>
                                                        <div class="col-sm-1" style="padding-left:3px; padding-right:0px;">
                                                                    <asp:CheckBox ID="CheckBoxActual" runat="server" AutoPostBack="true" Checked="false" ValidationGroup="g" 
                                                                      OnCheckedChanged="CheckBoxatual_CheckedChanged"  />
                                                                </div>                                                           
                                                            </div>
                                                    </div>
                                                    <div class="row ">
                         ...
                         <div class="row">
                          ...
                          <div class="row">
                            <div class="col-sm-12" id="Div12" runat="server">                               
                                ...
                                <div class="col-sm-4 ">
                                     <asp:TextBox ID="TextBox2" runat="server" onkeypress="filterDigits(event)" Enabled="false" CausesValidation="false" CssClass="form-control" Format="dd/MMM/yyyy" ></asp:TextBox>
                                                                <asp:Label ID="Label6" runat="server" Width="10px"></asp:Label>
                                                            </div>

                                                            <div class="col-sm-1 paddingLeft0" >

                                                                <asp:LinkButton ID="LinkButton7" runat="server" CausesValidation="false"> <span class="glyphicon glyphicon-calendar" aria-hidden="true"></span></asp:LinkButton>

                                                                <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="TextBox2" Animated="true"
                                                                    PopupButtonID="LinkButton7" Format="dd/MMM/yyyy">
                                                                </asp:CalendarExtender>
                                </div>                               
                            </div>
                        </div>
                          <div class="row">
                            <div class="col-sm-12" id="Div18" runat="server">                               
                                <div class="col-sm-2 labelText1">
                                   File Received Date
                                </div>
                                <div class="col-sm-4 paddingRight5">
                                    <asp:TextBox ID="TextBox3" CausesValidation="false" MaxLength="100" Class="form-control DateextBox1" AutoPostBack="true" runat="server" OnTextChanged="txtentryNo_TextChanged"></asp:TextBox>
                                </div>                               
                            </div>
                        </div>
                         <div class="row">
