<%@ Page Title="Good Receive Note" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="GoodReceiveNote.aspx.cs" Inherits="FF.WebERPClient.Inventory_Module.GoodReceiveNote"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="float: left; width: 98%">
        ...
        <%--Button Area--%>
        <div style="width: 100%; float: left; text-align:right; padding-top:1px; padding-bottom:1px;">
                <asp:Button ID="btnRequestSearch" runat="server" Text="Search" ClientIDMode="Static"  CssClass="Button" OnClick="btnRequestSearch_Click" />
                <asp:Button ID="btnConsReceiptSave"  runat="server" Text="Save" CssClass="Button" OnClick="btnConsReceiptSave_Click" />
                <asp:Button ID="btnConsReceiptClear" runat="server" Text="Clear" CssClass="Button" OnClick="btnConsReceiptClear_Click" />
        </div>

        <%--Pending Searching Area--%>
        <div style="float: left; width:100%;">
            <%--Pending Searching Area - Heading--%>
            <div style=" background-color: #1E4A9F; color: White; width: 98%; float: left; height:18px;">  Pending Purchase Order Entries  </div>
            ...
            <asp:CollapsiblePanelExtender ID="CPEPending" runat="server" TargetControlID="pnlPendingRequests"
            ...
            <%--Pending Searching Area - Criteria--%>
            <div style="width: 100%; float: left; color: Black; padding-top: 2px; padding-bottom: 2px;
                        background-color: #EEEEEE;">
            <asp:Panel ID="pnlPendingRequests" runat="server"  BorderStyle="None" ScrollBars="None"  >
                <div style="width: 100%; float: left; padding-top:2px; padding-bottom:2px;">
                    <div style="width: 15%; float: left">
                        From :<br />
                        <asp:TextBox ID="txtFromDate" runat="server" Width="75px" ClientIDMode="Static" CssClass="TextBox"></asp:TextBox>
                        <asp:Image ID="imgFromDate" runat="server" ImageUrl="~/Images/Calendar_scheduleHS.png" ImageAlign="Middle"  />
                    ...
                    <div style="width: 15%; float: left">
                        To :<br />
                        <asp:TextBox ID="txtToDate" runat="server" Width="75px" ClientIDMode="Static" CssClass="TextBox"></asp:TextBox>
                        <asp:Image ID="imgToDate" runat="server" ImageUrl="~/Images/Calendar_scheduleHS.png" ImageAlign="Middle"  />
                    ...
                    <div style="width: 35%; float: left">
                        Supplier :<br />
                        <asp:TextBox ID="txtSupplier" runat="server" Width="70%" ClientIDMode="Static" CssClass="TextBox"></asp:TextBox>
                        <asp:ImageButton ID="imgFindSupplier" runat="server" ImageUrl="~/Images/icon_search.png" ImageAlign="Middle" 
                            OnClick="ImageBtnSupplier_Click" />
                    </div>
                    <div style="width: 35%; float: left">
                        RequestNo :<br />
                        <asp:TextBox ID="txtRequestNo" runat="server" Width="70%" ClientIDMode="Static" CssClass="TextBox"></asp:TextBox>
                        <asp:ImageButton ID="imgFindRequestNo" runat="server" ImageUrl="~/Images/icon_search.png" ImageAlign="Middle" 
                            OnClick="imgPOSearch_Click" />
                    </div>
             </div>
                
                <asp:Panel ID="Panel1" runat="server"  BorderStyle="None" ScrollBars="Vertical" Height="115px" >
                    <asp:GridView ID="gvPendingRequests" runat="server" AutoGenerateColumns="False" CellPadding="3"
                    ForeColor="#333333" OnRowCommand="gvPendingRequests_RowCommand" CssClass="GridView"
                    GridLines="None">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Date" ShowHeader="true"  >
                            <ItemTemplate>
                                <asp:Label ID="lblReqDate" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Poh_dt","{0:dd/MM/yyyy}") %>'></asp:Label>
                                <%--for displya purpose, "Poh_dt" replaced by "Poh_remarks"--%>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
        ...
        <div style="float: left; width: 100%;">
            <%--Pending Searching Area - Heading--%>
            <div style=" background-color: #1E4A9F; color: White; width: 98%; float: left; height:18px;">  Receipt Item Details  </div>
            <%-- Collaps Image - Pending Documents --%>
            <div style="float: left;"> <asp:Image runat="server" ID="Image2" ImageUrl="~/Images/16 X 16 DownArrow.jpg" ImageAlign="Right" /></div>
            <%-- Collaps control - Pending Documents --%>
            <asp:CollapsiblePanelExtender ID="CollapsiblePanelExtender1" runat="server" TargetControlID="pnlReceiptItemDetails"
                        CollapsedSize="0" ExpandedSize="200" Collapsed="False" ExpandControlID="Image2"
            ...
            <div style="width: 100%; float: left; color: Black; padding-top: 2px; padding-bottom: 2px; ">
                <asp:Panel ID="pnlReceiptItemDetails" runat="server" ScrollBars="None"  >
                    <asp:TabContainer ID="tcReceiptItemDetails" runat="server" ActiveTabIndex="0" >
                        <asp:TabPanel ID="tbpItemDetails" HeaderText="Item Details" runat="server">
                            <ContentTemplate>
                                <asp:Panel ID="Panel2" runat="server" Width="100%" Height="150px" ScrollBars="Auto" >
                                    <asp:GridView ID="gvReceiptItemDetails" runat="server" AutoGenerateColumns="False"
                                    OnRowCommand="gvReceiptItemDetails_RowCommand" CellPadding="3" ForeColor="#333333"
                                    GridLines="None" OnRowDataBound="gvReceiptItemDetails_RowDataBound" Style="font-size: 11px;
                                    font-family: Verdana" CssClass="GridView">
                                    <AlternatingRowStyle BackColor="White" />
                                    <Columns>
                                            ...
                                            <asp:TextBox ID="txtActualQty" runat="server" Width="50px" Text='<%# DataBinder.Eval(Container.DataItem, "Actual_qty") %>'
                                                BorderStyle="None" Font-Bold="True" Font-Size="11px" ForeColor="Black"></asp:TextBox>
                                            </ItemTemplate>
                                            <HeaderStyle HorizontalAlign="Left" />
                                            <ItemStyle HorizontalAlign="Left" Width="70px" />
                                            </asp:TemplateField>
                                            ...
                                            <ItemTemplate>
                                            <asp:Button ID="btnAddSerials" runat="server" CssClass="Button" Text="Pick Serial"
                        ...
                        <asp:TabPanel ID="tbpSerialDetails" HeaderText="Serial Details" runat="server">
                            <ContentTemplate>
                                <asp:Panel ID="pnlAllItemsSerials" runat="server" Width="100%" Height="150px" ScrollBars="Auto" >
                                    <asp:GridView ID="gvAllItemSerials" runat="server" AutoGenerateColumns="False" CellPadding="3"
                                        ForeColor="#333333" GridLines="None" OnRowCommand="gvAllItemSerials_RowCommand"
                                        Style="font-size: 11px; font-family: Verdana" CssClass="GridView">
                                        <AlternatingRowStyle BackColor="White" />
                                        <Columns>
                                            ...
                                            <asp:TemplateField  >
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="imgbtndelAllSerial" runat="server" ImageUrl="~/Images/Delete.png" ImageAlign="Middle" Width="16px" Height="16px"
        ...
        <div style="float: left; width: 100%;">
            <%--Pending Searching Area - Heading--%>
            <div style=" background-color: #1E4A9F; color: White; width: 98%; float: left; height:18px;">  Request Info  </div>
            <%-- Collaps Image - Pending Documents --%>
            <div style="float: left;"> <asp:Image runat="server" ID="Image3" ImageUrl="~/Images/16 X 16 DownArrow.jpg" ImageAlign="Right" /></div>
            <%-- Collaps control - Pending Documents --%>
            <asp:CollapsiblePanelExtender ID="CollapsiblePanelExtender2" runat="server" TargetControlID="pnlRequestInfo"
                        CollapsedSize="0" ExpandedSize="200" Collapsed="False" ExpandControlID="Image3"
            ...
            <div style="width: 100%; float: left; color: Black; padding-top: 2px; padding-bottom: 2px; ">
                ...
                <div>
                    ...
                    <div class="SubDivCss">
                        ...
                        <div class="innerRightDivCss">
                            <asp:TextBox ID="txtReceiptDate" runat="server" Width="75px" CssClass="TextBox" ClientIDMode="Static"
                    ...
                    <div class="SubDivCss">
                        ...
                        <div class="innerLeftDivCss">
                            Ref No :</div>
                        <div class="innerRightDivCss">
                            <asp:TextBox ID="txtRefNo" runat="server" CssClass="TextBox" Width="150px" ClientIDMode="Static"
                ...
                <div>
                    ...
                    <div style="width: 90%; float: left">
                        <asp:TextBox ID="txtRemarks" runat="server" Width="100%" ClientIDMode="Static" TextMode="MultiLine"
                            Rows="2" MaxLength="30" Style="font-size: 11px; font-family: Verdana" CssClass="TextBox"></asp:TextBox>
                    </div>
                </div>
                </asp:Panel>
            </div>
        ...
        <asp:Panel ID="pnlAddSerials" runat="server" Height="380px" Width="500px" CssClass="ModalWindow">
            ...
            <div style="float: left; width: 100%">
                ...
                <div style="float: left; width: 100%" id="divSerial" runat="server" visible="false">
                    ...
                    <div class="MainDivCss">
                        Warranty &nbsp;&nbsp;:&nbsp; <asp:TextBox ID="txtWarrantyNo" runat="server" CssClass="commonDDLCss"
                            Width="150px" MaxLength="40"></asp:TextBox>
                        &nbsp;
                    </div>
                    <div class="MainDivCss">
