...
namespace FF.BusinessObjects
{
    ...
    public class PurchaseOrder
    {
        ...
        private string _poh_cre_by;

        //UI specific properties
        private string _fromDate = string.Empty;
        private string _toDate = string.Empty;

        private DateTime _fromDateNew ;
        private DateTime _toDateNew ;

        private string _poh_session_id;
        ...
        public string Poh_cre_by { get { return _poh_cre_by; } set { _poh_cre_by = value; } }
        public string poh_session_id { get { return _poh_session_id; } set { _poh_session_id = value; } }
        #region add by lakshan 
        public Int32 Poh_wp { get; set; }
        public string Poh_wp_usr { get; set; }
        public DateTime Poh_wp_st { get; set; }
        public DateTime Poh_wp_end { get; set; }

        #endregion
        public Int32 Poh_warr_period { get; set; }
        public string Poh_warr_remrk { get; set; }
        
        
        public DateTime FromDateNew
        {
            get { return _fromDateNew; }
            set { _fromDateNew = value; }
        }
        public DateTime ToDateNew
        {
            get { return _toDateNew; }
            set { _toDateNew = value; }
        }
        ...
        public static PurchaseOrder ConvertTotal(DataRow row)
        {
            return new PurchaseOrder
            {
                ...
                Poh_cre_by = row["POH_CRE_DT"] == DBNull.Value ? string.Empty : row["POH_CRE_DT"].ToString()
            };
        }
        public static PurchaseOrder ConvertNew(DataRow row)
        {
            return new PurchaseOrder
            {
                Poh_com = row["POH_COM"] == DBNull.Value ? string.Empty : row["POH_COM"].ToString(),
                ...
                poh_is_conspo = row["POH_IS_CONSPO"] == DBNull.Value ? 0 : Convert.ToInt32(row["POH_IS_CONSPO"]),
                Poh_cre_by = row["POH_CRE_DT"] == DBNull.Value ? string.Empty : row["POH_CRE_DT"].ToString(),
                Poh_wp = row["Poh_wp"] == DBNull.Value ? 0 : Convert.ToInt32(row["Poh_wp"]),
                Poh_wp_usr = row["Poh_wp_usr"] == DBNull.Value ? string.Empty : row["Poh_wp_usr"].ToString(),
                Poh_wp_st = row["Poh_wp_st"] == DBNull.Value ? DateTime.MinValue : Convert.ToDateTime(row["Poh_wp_st"]),
                Poh_wp_end = row["Poh_wp_end"] == DBNull.Value ? DateTime.MinValue : Convert.ToDateTime(row["Poh_wp_end"])
            };
        }
    }
}
