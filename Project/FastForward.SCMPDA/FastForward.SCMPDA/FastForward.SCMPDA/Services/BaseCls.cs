...
namespace FastForward.SCMPDA
{
    ...
    public static class BaseCls
    {
        ...
        public static string GlbVersionNo = ConfigurationManager.AppSettings["VersionNo"].ToString();
      ...
      //  public static string GlbUserDefLoca = string.Empty;
       ...
       // public static string GlbDefSubChannel = string.Empty;//Add by Chamal 19-03-2013
        ...
        public static string GlbPINo = string.Empty;//Add by Rukshan 26-06-2015
        //public static string GlbSBU = string.Empty;//Add by Rukshan 30-06-2015
        ...
        public static void RequestApprovalCycleDefinition(bool _isLocation, HirePurchasModuleApprovalCode _modulecode, DateTime _date, string _destinationcompany, string _destinationlocation, SalesPriorityHierarchyCategory _category, SalesPriorityHierarchyType _type)
        {
            ...
            if (_isLocation)
                //TODO: UNCOMMENT
                // _obj = CHNLSVC.Security.GetApproveCycleDefinitionDataforLocation(Session["UserCompanyName"].ToString(), BaseCls.GlbUserDefLoca, Convert.ToString(_modulecode), _date, _destinationcompany, _destinationlocation, Convert.ToString(_category), Convert.ToString(_type));
                ;
            else
                //TODO: UNCOMMENT
                ...
                if (_isLocation)
                    //TODO: UNCOMMENT
                    // _obj_ = CHNLSVC.Security.GetUserRequestApprovalPermissionDataForLocation(BaseCls.GlbUserName, Convert.ToString(_modulecode), Session["UserCompanyName"].ToString(), BaseCls.GlbUserDefLoca, Convert.ToString(_category), Convert.ToString(_type));
                    ;
                else
                    //TODO: UNCOMMENT
                    // _obj_ = CHNLSVC.Security.GetUserRequestApprovalPermissionDataForProfitCenter(BaseCls.GlbUserName, Convert.ToString(_modulecode), Session["UserCompanyName"].ToString(), BaseCls.GlbUserDefProf, Convert.ToString(_category), Convert.ToString(_type));
