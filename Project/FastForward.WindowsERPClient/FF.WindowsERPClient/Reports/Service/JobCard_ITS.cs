...
namespace FF.WindowsERPClient.Reports.Service {
    ...
    public class JobCard_ITS : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "FF.WindowsERPClient.Reports.Service.JobCard_ITS.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedJobCard_ITS : Component, ICachedReport {
        
        public CachedJobCard_ITS() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            JobCard_ITS rpt = new JobCard_ITS();
            rpt.Site = this.Site;
            return rpt;
        }
