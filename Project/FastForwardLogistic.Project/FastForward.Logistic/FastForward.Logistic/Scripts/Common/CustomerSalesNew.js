...
jQuery(document).ready(function () {
    ...
    jQuery(".btn.grph-disply-btn").click(function (evt) {
        evt.preventDefault();
        displayPopData();
    });
...
function addValuesFront(value, type) {
    ...
    jQuery.ajax({
        type: "GET",
        url: "/CustomerSalesNew/addSelectedValues",
...
function removeChipFront(value, type) {
    ...
    if (val != "") {
        jQuery.ajax({
            type: "GET",
            url: "/CustomerSalesNew/removeSelected",
            contentType: "application/json;charset=utf-8",
            dataType: "json",
...
function pagingCon(pgeNum, pgeSize) {
    ...
    jQuery.ajax({
        type: "GET",
        url: "/CustomerSalesNew/itmDetPaging?pgeNum=" + pgeNum + "&pgeSize=" + pgeSize,
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function message(mobile, name) {
    if (mobile == "" || mobile == "#" || mobile == "N/A") {
        showNotice("No Mobile Number Found");
    }
    else {
        $('#smsModal').modal('show');
...
jQuery(".btn.sms-btn").click(function (evt) {
    ...
    if (sms == "") {
        setErrorPopUp("Message area should not be empty!");
            ...
            success: function (result) {
                if (result.login == true) {
                    ...
                    if (result.success == false) {
                        // $('#smsModal').modal('hide');
                        setErrorPopUp("Message has been not sent");
                    }
                } else {
                    Logout();
                }
...
jQuery(".btn.sms-btn-all").click(function (evt) {
    ...
    if (smstoall == "") {
        ...
        jQuery.ajax({
            ...
            url: "/CustomerSalesNew/SendSMStoAll",
            contentType: "application/json;charset=utf-8",
            dataType: "json",
            success: function (result) {
                if (result.login == true) {
                    if (result.success == true) {
                        ...
                        showSuccess("Messages have been sent");
...
function loadAgeAndSalary() {
    jQuery.ajax({
        type: "GET",
        url: "/CustomerSalesNew/getAgeCategory",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
        data: { type: "AGE" },
        success: function (result) {
...
function clickedFunction(code, type) {
    ...
    jQuery.ajax({
        type: "GET",
        url: "/CustomerSalesNew/addMapData?type=" + type + "&value=" + code,
        contentType: "application/json;charset=utf-8",
        dataType: "json",
        //data: { pgeNum: pgeNum, pgeSize: pgeSize },
        success: function (result) {
    ...
    if (!i) {
        if (jQuery("#CheckAmount").val() != "") {
            ...
            jQuery.ajax({
                ...
                url: "/CustomerSalesNew/getCustomerDetails",
                contentType: "application/json;charset=utf-8",
                dataType: "json",
                success: function (result) {
                    if (result.login == true) {
            ...
            showNotice("Please enter check invoice amount.");
            //evt.preventDefault();
        }
    }
    else {
        if (jQuery("#CheckAmount").val() != "") {
           ...
           // evt.preventDefault();
            ...
            jQuery.ajax({
                ...
                url: "/CustomerSalesNew/getCustomerInvDetails",
                contentType: "application/json;charset=utf-8",
                dataType: "json",
                success: function (result) {
                    if (result.login == true) {
