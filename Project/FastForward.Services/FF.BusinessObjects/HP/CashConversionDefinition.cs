...
{
   public class CashConversionDefinition
    {
        ...
        public string Hcc_add_cal_on
        {
            get { return _hcc_add_cal_on; }
            set { _hcc_add_cal_on = value; }
        }
        public decimal Hcc_add_chg_rt
        {
            get { return _hcc_add_chg_rt; }
            set { _hcc_add_chg_rt = value; }
        }
        public decimal Hcc_add_chg_val
        {
            get { return _hcc_add_chg_val; }
            set { _hcc_add_chg_val = value; }
        }
        public string Hcc_cal_on
        {
            get { return _hcc_cal_on; }
            set { _hcc_cal_on = value; }
        }
        public DateTime Hcc_cc_upto
        {
            get { return _hcc_cc_upto; }
            set { _hcc_cc_upto = value; }
        }
        public string Hcc_chk_on
        {
            get { return _hcc_chk_on; }
            set { _hcc_chk_on = value; }
        }
        public string Hcc_cre_by
        {
            get { return _hcc_cre_by; }
            set { _hcc_cre_by = value; }
        }
        public DateTime Hcc_cre_dt
        {
            get { return _hcc_cre_dt; }
            set { _hcc_cre_dt = value; }
        }
        public DateTime Hcc_from_cre_dt
        {
            get { return _hcc_from_cre_dt; }
            set { _hcc_from_cre_dt = value; }
        }
        public Int32 Hcc_from_pd
        {
            get { return _hcc_from_pd; }
            set { _hcc_from_pd = value; }
        }
        public decimal Hcc_from_val
        {
            get { return _hcc_from_val; }
            set { _hcc_from_val = value; }
        }
        public string Hcc_pb
        {
            get { return _hcc_pb; }
            set { _hcc_pb = value; }
        }
        public string Hcc_pb_conv
        {
            get { return _hcc_pb_conv; }
            set { _hcc_pb_conv = value; }
        }
        public string Hcc_pb_lvl
        {
            get { return _hcc_pb_lvl; }
            set { _hcc_pb_lvl = value; }
        }
        public string Hcc_pty_cd
        {
            get { return _hcc_pty_cd; }
            set { _hcc_pty_cd = value; }
        }
        public string Hcc_pty_tp
        {
            get { return _hcc_pty_tp; }
            set { _hcc_pty_tp = value; }
        }
        public string Hcc_sch_cd
        {
            get { return _hcc_sch_cd; }
            set { _hcc_sch_cd = value; }
        }
        public Int32 Hcc_seq
        {
            get { return _hcc_seq; }
            set { _hcc_seq = value; }
        }
        public decimal Hcc_ser_chg_rt
        {
            get { return _hcc_ser_chg_rt; }
            set { _hcc_ser_chg_rt = value; }
        }
        public decimal Hcc_ser_chg_val
        {
            get { return _hcc_ser_chg_val; }
            set { _hcc_ser_chg_val = value; }
        }
        public DateTime Hcc_to_cre_dt
        {
            get { return _hcc_to_cre_dt; }
            set { _hcc_to_cre_dt = value; }
        }
        public Int32 Hcc_to_pd
        {
            get { return _hcc_to_pd; }
            set { _hcc_to_pd = value; }
        }
        public decimal Hcc_to_val
        {
            get { return _hcc_to_val; }
            set { _hcc_to_val = value; }
        }

        public static CashConversionDefinition Converter(DataRow row)
        {
            return new CashConversionDefinition
            {
