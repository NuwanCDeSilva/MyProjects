<%@ Page Language="C#" Title="Insuarance Receipt Print" AutoEventWireup="true" CodeBehind="InsuaranceReceiptPrint.aspx.cs" Inherits="FF.WebERPClient.Reports_Module.Sales_Rep.InsuaranceReceiptPrint" %>
...
<body >
    ...
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="ReceiptPrint.rpt">
        </Report>
