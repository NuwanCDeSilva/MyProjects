...
namespace FF.BusinessObjects.Security
{
    ...
    public class MasterCompany
    {
        ...
        private string _mc_grup = string.Empty;
        ...
        private Decimal _mc_anal26 = 0;   
        private string _MC_TAX_CALC_MTD = "";  
        private Int32 _MC_IS_SCM2_FMS = 0;      
        private Int32 _MC_IS_ECD = 0;  

        private Int32 _mc_resmultaxinv = 0;
        private Int32 _MC_IS_GRAN_WO_SER = 0; 
        private Int32 _mc_alw_minus_bal = 0;   
