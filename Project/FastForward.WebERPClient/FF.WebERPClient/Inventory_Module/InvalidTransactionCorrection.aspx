<%@ Page Title="Invalid Transaction Correction" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InvalidTransactionCorrection.aspx.cs" Inherits="FF.WebERPClient.Inventory_Module.InvalidTransactionCorrection" %>
...
<asp:Panel ID="PanelHeader1" runat="server" CssClass="PanelHeader" Font-Bold="True">Document Search Panal
    </asp:Panel>
...
<div style="float: left; width: 49%;">
    <asp:DropDownList ID="ddlDocType" runat="server" CssClass="ComboBox" 
        Width="95%">
...
<asp:Panel ID="Panel3" runat="server" CssClass="PanelHeader" Font-Bold="True">Item Details</asp:Panel>
    <asp:Panel ID="Panel2" runat="server" BackColor="White" Height="180px" 
        ScrollBars="Both">
        <asp:GridView ID="grvItemDet" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True"
            CellPadding="4" ForeColor="#333333" Width="99%" 
            onselectedindexchanged="grvItemDet_SelectedIndexChanged" 
            CssClass="GridView">
...
<asp:Panel ID="Panel4" runat="server" CssClass="PanelHeader" Font-Bold="True">Serial Details
</asp:Panel>
   <asp:Panel ID="Panel5" runat="server" BackColor="White" Height="180px" 
        ScrollBars="Both">
...
<div style="float: left; width: 100%;">
<asp:Panel ID="Panel6" runat="server" CssClass="PanelHeader" Font-Bold="True">Correction Details</asp:Panel>
    ...
    <div style="float: left; width: 1%; color: #333333;">   
        ...
        <div style="float: left; width: 30%;">
            <asp:TextBox ID="txtCorrectLoc" runat="server" CssClass="TextBox"></asp:TextBox>
            &nbsp;<asp:ImageButton ID="ImageButton2" runat="server" 
                ImageUrl="~/Images/icon_search.png" /></div>
    </div>
    <%--<div class="div100pcelt" style="padding: 3.0px">
     <div style="float: left; width: 1%; color: #333333;">   
        &nbsp;</div>
