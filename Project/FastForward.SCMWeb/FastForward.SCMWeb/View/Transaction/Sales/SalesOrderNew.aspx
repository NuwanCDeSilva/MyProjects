<%@ Page Title="" Language="C#" MasterPageFile="~/View/AdminSite.Master" AutoEventWireup="true" CodeBehind="SalesOrderNew.aspx.cs" EnableEventValidation="false" Inherits="FastForward.SCMWeb.View.Transaction.Sales.SalesOrderNew" %>
                ...
                <div class="row">
                    <div class="col-sm-12 buttonrow">
                        <asp:UpdatePanel runat="server">
                            <ContentTemplate>
                                <div class="col-sm-12 buttonRow paddingRight5" id="divTopCheck" runat="server">
                                    ...
                                    <div class="col-sm-2 buttonRow padding0">
                                      ...
                                      <div class="col-sm-2 paddingRight0 paddingLeft0" id="tempSaveDiv" runat="server" Visible="false">
                                                    <asp:LinkButton ID="LinkButton4" runat="server" CssClass="floatRight" CausesValidation="false" OnClientClick="ConfirmApproveOrder();" OnClick="lbtnapproveTemp_Click">
                            <span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span>Approve
                                                    </asp:LinkButton>
                                                </div>
                                    <div class="col-sm-5 buttonRow padding0 floatRight">
                            ...
                            <span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span>Final Approval
                                                    </asp:LinkButton>
                                                </div>
                                                <div class="col-sm-2 paddingRight0">
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-default paneldefaultheightorderplan salesinvfirstpnl" id="1s">
                                <div class="panel-heading pannelheading height16 paddingtop0">
                                    Sales Order
                                    <asp:RadioButton id="SoTempAll" runat="server" GroupName="soTempGroup" Text="All" Visible="false" Checked="false"></asp:RadioButton>
                                    <asp:RadioButton id="SoTempPending" runat="server" GroupName="soTempGroup" Text="Pending" Visible="false" Checked="false"></asp:RadioButton>
                                </div>
                                <asp:UpdatePanel runat="server">
                                    <ContentTemplate>
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <asp:TextBox ID="txtdocrefno" Enabled="false" Style="text-transform: uppercase" runat="server" TabIndex="3" CssClass="form-control"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
