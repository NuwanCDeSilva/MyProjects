...
{
    [Serializable]
    public class RequestApprovalDetail
    {
        ...
        private string _description;//added by Prabhath on 7/3/2013
        public string Description
        {
            get { return _description; }
            set { _description = value; }
        }
        private string _model;//added by Prabhath on 7/3/2013
        public string Model
        {
            get { return _model; }
            set { _model = value; }
        }
        //added by Prabhath on 8/3/2013
        ...
        private decimal _grad_cred_val;
        private decimal _Grad_Do_qty;
        private int _grad_inv_line;
        ...
        public decimal Grad_cred_val { get { return _grad_cred_val; } set { _grad_cred_val = value; } } // Darshana 22-jAN-2016
        public decimal Grad_Do_qty { get { return _Grad_Do_qty; } set { _Grad_Do_qty = value; } } // Darshana 22-jAN-2016
        public int Grad_inv_line { get { return _grad_inv_line; } set { _grad_inv_line = value; } }

        public static RequestApprovalDetail Converter(DataRow row)
        {
            return new RequestApprovalDetail
            {
                ...
                Grad_cred_val = row["GRAD_CRED_VAL"] == DBNull.Value ? 0 : Convert.ToDecimal(row["GRAD_CRED_VAL"]),
                Grad_inv_line = row["GRAD_INV_LINE"] == DBNull.Value ? 0 : Convert.ToInt16(row["GRAD_INV_LINE"])
            };
        }

        //added by Prabhath on 8/3/2013
        public static RequestApprovalDetail ConverterItem(DataRow row)
        {
            return new RequestApprovalDetail
            {
                Grad_anal1 = row["GRAD_ANAL1"] == DBNull.Value ? string.Empty : row["GRAD_ANAL1"].ToString(),
