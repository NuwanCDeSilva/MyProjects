<%@ Page Title="" Language="C#" MasterPageFile="~/View/AdminSite.Master" AutoEventWireup="true" CodeBehind="SalesTarget.aspx.cs" Inherits="FastForward.SCMWeb.View.Transaction.Forecasting.SalesTarget" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
                                ...
                                <div class="col-sm-6 paddingRight0 text-right">
                                    <div class="buttonRow" style="height: 30px; margin-top: -12px;">
                                        ...
                                        <div class="col-sm-2 padding0 text-center" style="width: 130px;">
                                            ...
                                            <span class="glyphicon glyphicon-saved" aria-hidden="true"></span>Combine Targets </asp:LinkButton>
                                        </div>
                                        <div class="col-sm-2 padding0 text-center" style="width: 110px;">
                                            <asp:LinkButton ID="lbtnchangedate" OnClick="lbtnchangedate_Click" CausesValidation="false" runat="server"> 
                                            <span class="glyphicon glyphicon-upload" aria-hidden="true"></span>Change Month</asp:LinkButton>
                                        </div>
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    <div class="panel panel-heading">
                                        <strong><b>Sales Target</b></strong>
                                    </div>
                                                            ...
                                                            <div class="panel panel-default">
                                                                <div class="panel panel-body padding0">
                                                                    ...
                                                                    <span class="glyphicon glyphicon-search"  aria-hidden="true"></span>
                                                                            ...
                                                                            <div class="col-sm-2 labelText1 padding3">
                                                                            ...
                                                                            <div class="col-sm-2 paddingRight0">
                                                                                ...
                                                                                <div class="col-sm-7 padding0">
                                                                                    <asp:TextBox AutoPostBack="true" Style="text-transform: uppercase" OnTextChanged="txtexc_TextChanged" ID="txtexc" CssClass="form-control" runat="server" />
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-1 padding3">
                                                                                <asp:LinkButton ID="lbtnexc" runat="server" OnClick="lbtnexc_Click">
                                                                    <span class="glyphicon glyphicon-search"  aria-hidden="true"></span>
                                                                                </asp:LinkButton>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-12">
                                                                            <div class="col-sm-4">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <asp:DropDownList AutoPostBack="true" OnSelectedIndexChanged="ddlCatDefOn_SelectedIndexChanged" CssClass="form-control" runat="server" ID="ddlCatDefOn">
                                                                                        ...
                                                                                        <asp:ListItem Value="QTY" Text="QTY" />
                                                                                    </asp:DropDownList>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-2 paddingRight0">
                                                                                ...
                                                                                <div class="col-sm-7 padding0">
                                                                                    <asp:TextBox AutoPostBack="true" Style="text-transform: uppercase" ID="txtmanager" OnTextChanged="txtmanager_TextChanged" CssClass="form-control" runat="server" />
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-2 labelText1">
                                                                                <div class="col-sm-12">
                                                                                    <asp:CheckBox Checked="true" Text="Active" ID="chkActTarg" runat="server" />
                                                                                </div>
                                                                            ...
                                                                            <div class="col-sm-3 paddingRight0">
                                                                                ...
                                                                                <div class="col-sm-7 padding0">
                                                                                    <asp:TextBox AutoPostBack="true" Style="text-transform: uppercase" OnTextChanged="txtinvtype_TextChanged1" ID="txtinvtype" CssClass="form-control" runat="server" />
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-1 padding3">
                                                                                <%-- <asp:LinkButton ID="lbtninvtype" runat="server" OnClick="lbtninvtype_Click1">
                                                                    <span class="glyphicon glyphicon-search"  aria-hidden="true"></span>
                                                                                </asp:LinkButton>--%>
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="divTar" id="divTar" onscroll="setScrollPosition(this.scrollTop);" style="height: 350px; overflow-y: auto;">
                                                            <asp:GridView ID="dgvTarget" CssClass="table table-hover table-striped" runat="server" GridLines="None"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Exc Cd">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbexccd" Text='<%# Bind("sfd_exc") %>' runat="server" Width="100%" />
                                                                        </ItemTemplate>
                                                                        <ItemStyle Width="80px" />
                                                                        <HeaderStyle Width="80px" />
                                                                    </asp:TemplateField>
                                                                     <asp:TemplateField HeaderText="Manager">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbmanager" Text='<%# Bind("sfd_manager") %>' runat="server" Width="100%" />
                                                                        </ItemTemplate>
                                                                        <ItemStyle Width="80px" />
                                                                        <HeaderStyle Width="80px" />
                                                                    </asp:TemplateField>
                                                                    <asp:TemplateField HeaderText="Inv Type">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbinvtype" Text='<%# Bind("sfd_inv_type") %>' runat="server" Width="100%" />
                                                                        </ItemTemplate>
                                                                        <ItemStyle Width="80px" />
                                                                        <HeaderStyle Width="80px" />
                                                                    </asp:TemplateField>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel6">
        ...
        <ContentTemplate>
            <asp:Button ID="btn001" runat="server" Text="Button" Style="display: none;" />
            <asp:ModalPopupExtender ID="popupchngedt" runat="server" Enabled="True" TargetControlID="btn001"
                PopupControlID="pnldatechange" PopupDragHandleControlID="PopupHeader" Drag="true" BackgroundCssClass="modalBackground">
            </asp:ModalPopupExtender>
        </ContentTemplate>
    </asp:UpdatePanel>
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel7">
      ...
      <asp:UpdatePanel runat="server" ID="UpdatePanel16">
        <ContentTemplate>
            <asp:Panel runat="server" ID="pnldatechange">
                <div runat="server" id="Div7" class="panel panel-primary" style="padding: 5px;">
                    <div class="panel panel-default" style="width: 650px;">
                        <div class="panel-heading" style="height: 25px;">
                            <div class="col-sm-11 padding0">
                                <strong>Target Date Change</strong>
                            </div>
                            <div class="col-sm-1">
                            </div>
                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="row buttonRow">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-5 padding0">
                                                        <div class="col-sm-4">
                                                            <asp:LinkButton ID="lbtnsavedatechange" OnClientClick="return ConfSave()" runat="server" OnClick="lbtnsavedatechange_Click">
                                                      <span class="glyphicon glyphicon-saved"  aria-hidden="true"></span>Save
                                                            </asp:LinkButton>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            <asp:LinkButton ID="lbtnclosedatechange" runat="server" OnClick="lbtnclosedatechange_Click">
                                                    <span class="glyphicon glyphicon-remove"  aria-hidden="true"></span>Close
                                                            </asp:LinkButton>
                                                        </div>
                                                    </div>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-sm-12">
                                                                                    <div class="col-sm-5 padding0">
                                                                                        ...
                                                                                        <div class="col-sm-4 padding0">
                                                                                            <asp:TextBox runat="server"  Style="text-transform: uppercase" CssClass="form-control" ID="txtchngefdt" />
                                                                                            <asp:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtchngefdt"
                                                                                                PopupButtonID="LinkButton8" Format="dd/MMM/yyyy">
                                                                                            </asp:CalendarExtender>
                                                                                        </div>
                                                                                        <div class="col-sm-1 padding3">
                                                                                    ...
                                                                                    <div class="col-sm-5 padding0">
                                                                                        ...
                                                                                        <div class="col-sm-4 padding0">
                                                                                            <asp:TextBox runat="server" Enabled="false" Style="text-transform: uppercase" CssClass="form-control" ID="txtchngetdt" />
                                                                                            <asp:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtchngetdt"
