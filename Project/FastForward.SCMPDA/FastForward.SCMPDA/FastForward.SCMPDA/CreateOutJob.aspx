<%@ Page Title="" Language="C#" MasterPageFile="~/PDAWeb.Master" AutoEventWireup="true" CodeBehind="CreateOutJob.aspx.cs" Inherits="FastForward.SCMPDA.CreateOutJob" %>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div id="serialdv" runat="server">
                                        ...
                                        <div class="col-sm-12 set-height">
                                            <div class="row">
                                                <div class="set-in-row">
                                                    <div class="labelText1 lbltxt-set">Serial #</div>
                                        ...
                                        <div id="serial2dv" runat="server">
                                            ...
                                            <div class="col-sm-12 set-height">
                                                <div class="row">
                                                    <div class="labelText1 lbltxt-set"></div>
                                                    <div class="col-sm-6">
