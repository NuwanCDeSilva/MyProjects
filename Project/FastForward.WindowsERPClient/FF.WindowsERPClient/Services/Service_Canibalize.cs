...
{
    public partial class Service_Canibalize : Base
    {
        ...
        private void LoadSerialData()
        {
            ...
            if (txtItem.Text != "")
            {
                ...
                {
                    MessageBox.Show("Not allow for canibalize.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    txtItem.Text = "";
                    txtItem.Focus();
                    return;
                }
        ...
        private void btnSave_Click_1(object sender, EventArgs e)
        {
            ...
            result = CHNLSVC.CustService.Save_ItemCanibalize(masterAuto, outHeader, reptPickSerialsList, _SubSerialList, "N",out documntNo);
