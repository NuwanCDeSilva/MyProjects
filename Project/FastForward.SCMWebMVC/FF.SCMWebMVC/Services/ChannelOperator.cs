...
namespace FF.SCMWebMVC.Services
{
    public class ChannelOperator
    {
        ...
        IDashboard DashboardObj;
        IFinancial financialObj;
        IMsgPortal Msgportalobj;
        ...
        public IFinancial Finance
        {
            get
            {
                if (financialObj == null)
                {
                    ChannelFactory<IFinancial> financechannel = new ChannelFactory<IFinancial>("FinancialEndPoint");
                    chanelList.Add(financechannel);
                    financialObj = financechannel.CreateChannel();
        ...
        public IDashboard Dashboard
        {
            get
            {
                ...
                {
                    ChannelFactory<IDashboard> DashServiceChannel = new ChannelFactory<IDashboard>("DashboardEndPoint");
                    chanelList.Add(DashServiceChannel);
                    DashboardObj = DashServiceChannel.CreateChannel();
        ...
        //Msg Service Channel
        public IMsgPortal MsgPortal
        {
            get
            {
                if (Msgportalobj == null)
                {
                    ChannelFactory<IMsgPortal> MsgPChannel = new ChannelFactory<IMsgPortal>("MsgPortalEndPoint");
                    chanelList.Add(MsgPChannel);
                    Msgportalobj = MsgPChannel.CreateChannel();
        ...
        public void CloseChannel()
        {
            ...
            if (DashboardObj != null && ((((IClientChannel)DashboardObj).State == CommunicationState.Faulted) || (((IClientChannel)DashboardObj).State == CommunicationState.Closed)))
            { DashboardObj = null; }
        }
    }
}