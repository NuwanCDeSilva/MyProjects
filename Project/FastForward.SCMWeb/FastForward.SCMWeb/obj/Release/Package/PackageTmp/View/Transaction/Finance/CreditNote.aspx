<%@ Page Title="" Language="C#" MasterPageFile="~/View/AdminSite.Master" AutoEventWireup="true" CodeBehind="CreditNote.aspx.cs" Inherits="FastForward.SCMWeb.View.Transaction.Finance.CreditNote" %>
                                                    ...
                                                    <div class="panel-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        ...
                                                                        <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                            <asp:TextBox placeHolder="Reversal Search" runat="server" ReadOnly="true" ID="txtCrdNte" CausesValidation="false" CssClass="form-control" Width="108px"></asp:TextBox>
                                                                        </div>
                                                                        <div class="col-sm-1 paddingLeft5 Lwidth">
                                                                            <asp:LinkButton ID="lbtnCrdNte" runat="server" CausesValidation="false" OnClick="lbtnCrdNte_Click">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                    <asp:TextBox runat="server" ReadOnly="true" ID="txtInvoice" CausesValidation="false" TabIndex="2" CssClass="form-control" OnTextChanged="txtInvoiceNo_TextChanged" ></asp:TextBox>
                                                                </div>
                                                                <div class="col-sm-1 paddingLeft5 Lwidth">
                                                                ...
                                                                <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                    <asp:TextBox runat="server" ID="txtCus" CausesValidation="false" TabIndex="3" CssClass="form-control" OnTextChanged="txtCus_TextChanged"></asp:TextBox>
                                                                </div>
                                                                <div class="col-sm-1 paddingLeft5 Lwidth">
                                                        ...
                                                        <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
                                                                ...
                                                                <div class="col-sm-1 paddingLeft5 Lwidth">
                                                                    <asp:LinkButton ID="lbtnCreditNoteNo" runat="server" CausesValidation="false" OnClick="lbtnCreditNoteNo_Click">
                                                                ...
                                                                <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                    <asp:TextBox ReadOnly="true" runat="server" Enabled="true" ID="txtDate" CausesValidation="false" TabIndex="4" CssClass="form-control" OnTextChanged="txtDate_TextChanged"></asp:TextBox>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                    <asp:TextBox runat="server" ID="txtExecutive" CausesValidation="false" TabIndex="5" CssClass="form-control" OnTextChanged="txtExecutive_TextChanged"></asp:TextBox>
                                                                </div>
                                                                <div class="col-sm-1 paddingLeft5 Lwidth">
                                                                ...
                                                                <span style="padding-left: 180px">
                                                                    ...
                                                                    <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                        <asp:TextBox Text="0.00" onkeydown="return jsDecimals(event);" Style="text-align: right" runat="server" ReadOnly="true" ID="txtTotAmt" CausesValidation="false" TabIndex="6" CssClass="form-control"></asp:TextBox>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                        <asp:TextBox Text="0.00" onkeydown="return jsDecimals(event);" Style="text-align: right" runat="server" ReadOnly="true" ID="txtPaidAmt" CausesValidation="false" TabIndex="7" CssClass="form-control"></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-sm-2 paddingLeft5 Lwidth"></div>
                                                                    <div class="col-sm-1 labelText1">
                                                                        Balance Amount :
                                                                    ...
                                                                    <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                        <asp:TextBox Text="0.00" onkeydown="return jsDecimals(event);" Style="text-align: right" runat="server" ReadOnly="true" ID="txtBalAmt" CausesValidation="false" TabIndex="8" CssClass="form-control"></asp:TextBox>
                                                                    </div>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                    <asp:TextBox ID="txtItem" TabIndex="9" runat="server" AutoPostBack="true" Style="text-transform: uppercase" CssClass="form-control" onKeydown="keyDownItem(event)" OnTextChanged="txtItem_TextChanged"></asp:TextBox>
                                                                </div>
                                                                <div class="col-sm-1 paddingLeft5 Lwidth">
                                                        ...
                                                        <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
                                                                ...
                                                                <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                    <asp:TextBox ReadOnly="true" ID="txtDescription" runat="server" Style="text-align: right" AutoPostBack="true" TabIndex="10" CssClass="form-control"></asp:TextBox>
                                                                </div>
                                                                <div class="col-sm-1 labelText1 ">
                                                                    Qty :
                                                                </div>
                                                                <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                    <asp:TextBox MaxLength="10" Text="0.00" ID="txtQty" runat="server" TabIndex="10" onkeydown="return jsDecimals(event);" Style="text-align: right" AutoPostBack="true" CssClass="form-control" OnTextChanged="txtQty_TextChanged"></asp:TextBox>
                                                                </div>
                                                                <div class="col-sm-1 paddingLeft5 Lwidth" style="visibility: hidden">
                                                                </div>
                                                                <div class="col-sm-1 labelText1">
                                                                ...
                                                                <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                    <asp:TextBox MaxLength="10" Text="0.00" ID="txtUnitPrice" runat="server" TabIndex="11" AutoPostBack="true" Style="text-align: right" onkeydown="return jsDecimals(event);" CssClass="form-control" OnTextChanged="txtUnitPrice_TextChanged"></asp:TextBox>
                                                                </div>
                                                                <div class="col-sm-2 paddingLeft5 Lwidth"></div>
                                                                <div class="col-sm-1 labelText1">
                                                                    Unit Amount :
                                                                ...
                                                                <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                    <asp:TextBox Text="0.00" ID="txtUnitAmt" runat="server" TabIndex="12" ReadOnly="true" onkeydown="return jsDecimals(event);" Style="text-align: right" CssClass="form-control"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                    <asp:TextBox MaxLength="10" Text="0.00" ID="txtDisRate" runat="server" TabIndex="13" onkeydown="return jsDecimals(event);" Style="text-align: right" CssClass="form-control" AutoPostBack="true" OnTextChanged="txtDisRate_TextChanged"></asp:TextBox>
                                                                </div>
                                                                <div class="col-sm-1 paddingLeft5 Lwidth" style="visibility: hidden">
                                                                </div>
                                                                <div class="col-sm-1 labelText1">
                                                                ...
                                                                <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                    <asp:TextBox Text="0.00" ID="txtDisAmt" runat="server" ReadOnly="true" TabIndex="14" onkeydown="return jsDecimals(event);" Style="text-align: right" CssClass="form-control" AutoPostBack="true"></asp:TextBox>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                    <asp:TextBox Text="0.00" ID="txtTaxAmt" ReadOnly="true" runat="server" TabIndex="15" onkeydown="return jsDecimals(event);" Style="text-align: right" CssClass="form-control"></asp:TextBox>
                                                                </div>
                                                                <div class="col-sm-1 paddingLeft5 Lwidth">
                                                                </div>
                                                                <div class="col-sm-1 labelText1">
                                                                ...
                                                                <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                    <asp:TextBox Text="0.00" ID="txtLineTotAmt" ReadOnly="true" runat="server" TabIndex="16" onkeydown="return jsDecimals(event);" Style="text-align: right" CssClass="form-control"></asp:TextBox>
                                                                </div>
                                                                <div class="col-sm-1 paddingLeft5 Lwidth">
                                                                </div>
                                                        ...
                                                        <asp:GridView ID="grdInvoices" EmptyDataText="No data found..." ShowHeaderWhenEmpty="True" runat="server" GridLines="Both" CssClass="table table-hover table-striped" AutoGenerateColumns="false" OnSelectedIndexChanged="grdInvoices_SelectedIndexChanged">
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="CreditNoteNo" Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="col_CreditNoteNo" runat="server" Text='<%# Bind("CreditNoteNo") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
