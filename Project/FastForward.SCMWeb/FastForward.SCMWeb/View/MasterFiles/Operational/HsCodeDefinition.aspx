...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                 ...
                                                 <asp:LinkButton ID="lbtnPopUpSearch" CausesValidation="false" OnClick="lbtnPopUpSearch_Click" runat="server"> 
                                                     <span class="glyphicon glyphicon-search" aria-hidden="true"  ></span>HS Search 
  ...
  <%--  <div id="divDocument" class="row" >
        <div class="col-sm-12">--%>
            <asp:Panel runat="server" ID="panelDocument" style="width:1250px ;height:600px">
                <div class="panel panel-default">
                    <div class="panel panel-heading">
                        <div class="row">
                            <div class="col-sm-8">
                                <strong>Search HS</strong>
                            </div>
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-4 paddingRight5">
                                            <asp:TextBox runat="server" ID="txtEntrymodal" CausesValidation="false" AutoPostBack="true" CssClass="form-control" OnTextChanged="txtentry_TextChanged"></asp:TextBox>
                                        </div>
                                        <div class="col-sm-1 paddingLeft0">
                                            <asp:LinkButton ID="lBtnItemCode" CausesValidation="false" runat="server"  OnClick="entry_search" >
                                                                                <span class="glyphicon glyphicon-search" aria-hidden="true"  ></span>
                                            </asp:LinkButton>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-4 paddingRight5">
                                            <asp:TextBox runat="server" ID="txtDescription" CausesValidation="false"   CssClass="form-control"></asp:TextBox>
                                        </div>
                                         <div class="col-sm-1 paddingLeft0">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-4 paddingRight5">
                                            <asp:TextBox runat="server" ID="txtHSCodepopup" CausesValidation="false" AutoPostBack="true" CssClass="form-control" OnTextChanged="txths_TextChanged"></asp:TextBox>
                                        </div>
                                        <div class="col-sm-1 paddingLeft0">
                                            <asp:LinkButton ID="lBtnHSCode" CausesValidation="false" runat="server" OnClick="hs_searchModal">
                                                            <span class="glyphicon glyphicon-search" aria-hidden="true"   ></span>
                                            </asp:LinkButton>
                                        </div>
                                        <div class="col-sm-5 paddingRight0">
                                            <asp:Button Text="Search" ID="ButtonSearchCusDec" runat="server" OnClick="btnSearchAllClick" />
                                        </div>
                                    </div>
                                </div>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                                    ...
                                                                    <asp:GridView ID="GridViewSearch" ShowHeader="True" PageSize="20" PagerStyle-CssClass="cssPager" OnPageIndexChanging="dgvSearchAll_PageIndexChanging"
                                                                         CssClass="table table-hover table-striped" runat="server" AllowPaging="True">
