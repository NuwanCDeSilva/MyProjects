...
namespace FF.BusinessObjects
{
    ...
    {//
        ...
        private Int32 _salcm_issue_phy_cd;// Added by Udesh 02-Nov-2018
        private DateTime _salcm_lst_exp_dt;// Added by Udesh 02-Nov-2018
        #endregion
        ...
        // Added by Udesh 02-Nov-2018
        public Int32 Salcm_issue_phy_cd
        {
            get { return _salcm_issue_phy_cd; }
            set { _salcm_issue_phy_cd = value; }
        }
        // Added by Udesh 02-Nov-2018
        public DateTime Salcm_lst_exp_dt
        {
            get { return _salcm_lst_exp_dt; }
            set { _salcm_lst_exp_dt = value; }
        }
        ...
        public static LoyaltyMemeber Converter(DataRow row)
        {
            return new LoyaltyMemeber
            {
                ...
                Salcm_issue_phy_cd = row["SALCM_ISSUE_PHY_CD"] == DBNull.Value ? 0 : Convert.ToInt32(row["SALCM_ISSUE_PHY_CD"]),// Added by Udesh 02-Nov-2018
                Salcm_lst_exp_dt = row["SALCM_LST_EXP_DT"] == DBNull.Value ? DateTime.MinValue : Convert.ToDateTime(row["SALCM_LST_EXP_DT"])// Added by Udesh 02-Nov-2018
            };
        }
