...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
                                            ...
                                            <div class="panel-heading paddingbottom0 paddingtop0" role="tab" id="">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <div class="col-sm-3 paddingLeft0" runat="server" id="NewItemDiv">
                                                            New Item
                                                        </div>
                                                        <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                            <asp:CheckBox ID="CheckBoxExcess" runat="server" OnCheckedChanged="checkbox_Changed" AutoPostBack="true"></asp:CheckBox>
                                                        </div>
                                                        <div class="col-sm-3 paddingLeft0" runat="server" id="Div18">
                                                            Excess Item
                                                        </div>
                                                    </div>
    ...
    <asp:Panel ID="Panel2" runat="server" align="center">
        <div runat="server" id="Div16" class="panel panel-info  width500">
            ...
            <asp:UpdatePanel ID="UpdatePanel47" runat="server">
                <ContentTemplate>
                    <div class="panel panel-danger">
                        ...
                        <div class="panel-body">
                                      <asp:GridView ID="GridViewPoExceed" EmptyDataText="No data found..." ShowHeaderWhenEmpty="True" runat="server" GridLines="None"
                                                                                    CssClass="table table-hover table-striped" AutoGenerateColumns="false">
                                                                                    <Columns>
                                                                                        <asp:TemplateField HeaderText="Row No">
                                                                                            <ItemTemplate>
