...
namespace FF.BusinessObjects
{
    public class InventoryBatchRefN
    {
        ...
        private Int32 _inb_job_line;
        private DateTime _inb_exp_dt;
        private DateTime _inb_manufac_dt;
        private string _inb_mitm_cd;
        private DateTime _Inb_batch_dt;//Wimal 03/May/2018
        private decimal _Inb_orig_cost;//Wimal 03/June/2018
        ...
        public Int32 Inb_job_line { get { return _inb_job_line; } set { _inb_job_line = value; } }
        public DateTime Inb_exp_dt { get { return _inb_exp_dt; } set { _inb_exp_dt = value; } }
        public DateTime Inb_manufac_dt { get { return _inb_manufac_dt; } set { _inb_manufac_dt = value; } }
        public string Inb_mitm_cd { get { return _inb_mitm_cd; } set { _inb_mitm_cd = value; } }
        public decimal Tmp_inb_used_qty { get; set; }
        public DateTime Inb_batch_dt { get { return _Inb_batch_dt; } set { _Inb_batch_dt = value; } }//Wimal 03/May/2018
        public decimal Inb_orig_cost { get { return _Inb_orig_cost; } set { _Inb_orig_cost = value; } }//Wimal 03/June/2018
        public static InventoryBatchRefN Converter(DataRow row)
        {
            return new InventoryBatchRefN
            {
                ...
                Inb_exp_dt = row["INB_EXP_DT"] == DBNull.Value ? DateTime.MinValue : Convert.ToDateTime(row["INB_EXP_DT"]),
                Inb_manufac_dt = row["INB_MANUFAC_DT"] == DBNull.Value ? DateTime.MinValue : Convert.ToDateTime(row["INB_MANUFAC_DT"]),
                Inb_mitm_cd = row["INB_MITM_CD"] == DBNull.Value ? string.Empty : row["INB_MITM_CD"].ToString(),
                Inb_batch_dt = row["INB_BATCH_DT"] == DBNull.Value ? DateTime.MinValue : Convert.ToDateTime(row["INB_BATCH_DT"]),
                Inb_orig_cost = row["INB_ORIG_COST"] == DBNull.Value ? 0 : Convert.ToDecimal(row["INB_ORIG_COST"]),
            };
        }
    }
}
