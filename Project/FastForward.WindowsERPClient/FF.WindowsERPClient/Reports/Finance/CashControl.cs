...
namespace FF.WindowsERPClient.Reports.Finance {
    ...
    public class CashControl : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "FF.WindowsERPClient.Reports.Finance.CashControl.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCashControl : Component, ICachedReport {
        
        public CachedCashControl() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CashControl rpt = new CashControl();
            rpt.Site = this.Site;
            return rpt;
        }
