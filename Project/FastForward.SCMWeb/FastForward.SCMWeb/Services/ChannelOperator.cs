...
namespace FastForward.SCMWeb
{
    public class ChannelOperator
    {
        ...
        //Message & Reports Portal Channel
        public IMsgPortal MsgPortal
        {
            get
            {
                ...
                {
                    ChannelFactory<IMsgPortal> MsgPortalChannel = new ChannelFactory<IMsgPortal>("MsgPortalEndPoint");
                    chanelList.Add(MsgPortalChannel);
                    MsgPortalObj = MsgPortalChannel.CreateChannel();
