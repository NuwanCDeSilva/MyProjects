<%@ Page Title="" Language="C#" MasterPageFile="~/View/AdminSite.Master" AutoEventWireup="true" CodeBehind="AssetMaster.aspx.cs" Inherits="FastForward.SCMWeb.View.MasterFiles.AssetManagement.AssetMaster" %>
                ...
                <div class="col-sm-12 ">
                    <div class="bs-example">
                        <ul class="nav nav-tabs" id="myTab">
                            ...
                            <li tabindex="132"><a href="#WarrantyPeriod" data-toggle="tab">Warranty Details</a></li>
                            <li><a href="#itemCost" data-toggle="tab">Asset Cost </a></li>
                                                       ...
                                                       <%-- <div class="row">
                                                          ...
                                                          <div class="row">
                                                            <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-6 paddingRight5 paddingLeft0">
                                                                    <asp:TextBox ID="txtResidual" CausesValidation="false" AutoPostBack="true" runat="server" class="form-control" onkeypress="return isNumberKey(event)" TabIndex="118"></asp:TextBox>
                                                                </div>
                                                               <%-- <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                    <asp:LinkButton ID="lbtnSrch_cat4" runat="server" OnClick="lbtnSrch_cat4_Click" TabIndex="119">
                                                            <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                ...
                                                                <div class="col-sm-4 paddingRight5 paddingLeft0">
                                                                    <asp:TextBox ID="txttrimRight" CausesValidation="false" runat="server" class="form-control" TabIndex="129"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        </div>
                                                         ...
                                                         Multiple
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12 paddingLeft0">
                                                                    ...
                                                                    <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                        <asp:LinkButton ID="lbtnsearchRedeemCom" runat="server" >
                                                            <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                                                                        </asp:LinkButton>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-sm-5 paddingLeft0">
                                                            <div class="row">
                                                                <div class="col-sm-12 paddingLeft0">
                                                                    ...
                                                                    <div class="col-sm-6 paddingRight5 paddingLeft0">
                                                                        <asp:TextBox ID="txtMrnCom" AutoPostBack="true" CausesValidation="false" runat="server" class="form-control" ></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12 paddingLeft0">
                                                                    ...
                                                                    <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                        <asp:LinkButton ID="lbtnSearchgvMRN" runat="server" >
                                                            <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                                                                        </asp:LinkButton>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-sm-5">
                                                                        <div class="row">
                                                                            <div class="col-sm-12 paddingLeft5">
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <asp:TextBox runat="server" ID="txtFgood" AutoPostBack="true" CausesValidation="false" CssClass="form-control" ></asp:TextBox>
                                                                                </div>
                                                                                <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                    ...
                                                                    <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-sm-12 paddingLeft5">
                                                                                ...
                                                                                <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                                    <asp:LinkButton ID="lbtnAddstatus" runat="server" CausesValidation="false" >
                                                                    <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                                                                                    </asp:LinkButton>
                                                                                </div>
                                                                            </div>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="row">
                                                                    <div class="col-sm-12 paddingLeft0">
                                                                        ...
                                                                        <div class="col-sm-6 paddingRight5 paddingLeft0">
                                                                            <asp:TextBox ID="txtkitItem" AutoPostBack="true" CausesValidation="false" runat="server" class="form-control" ></asp:TextBox>
                                                                        </div>
                                                                        <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                            <asp:LinkButton ID="lbtnSearchKit" runat="server" >
                                                            <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
                                                                            </asp:LinkButton>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12 paddingLeft0">
                                                                        ...
                                                                        <div class="col-sm-6 paddingRight5 paddingLeft0">
                                                                            <asp:DropDownList AutoPostBack="true" ID="ddlCostMeth"  runat="server" class="form-control">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12 paddingLeft0">
                                                                        ...
                                                                        <div class="col-sm-6 paddingRight5 paddingLeft0">
                                                                            <asp:TextBox ID="txtunits" AutoPostBack="true"  CausesValidation="false" runat="server" class="diWMClick validateDecimal form-control"></asp:TextBox>
                                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12 paddingLeft0">
                                                                        ...
                                                                        <div class="col-sm-1 paddingLeft0 paddingRight0">
                                                                            <asp:LinkButton ID="lbtnAddKit" runat="server" >
                                                            <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
                                                                            </asp:LinkButton>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <asp:GridView ID="grdKit" CssClass="grdKitStyle table table-hover table-striped" runat="server" GridLines="None" ShowHeaderWhenEmpty="True"
                                                                        ...
                                                                        <Columns>
                                                                            <asp:TemplateField HeaderText="" Visible="true">
                                                                                <ItemTemplate>
                                                                                    <asp:CheckBox ID="chk_Kitcheck" AutoPostBack="true" runat="server" onclick="CheckBoxCheck(this);"  Checked="false" Width="100%" />
                                                                                </ItemTemplate>
