jQuery(document).ready(function () {
        ...
        Lobibox.confirm({
            ...
            callback: function ($this, type, ev) {
                if (type == "yes") {
                    ...
                    jQuery.ajax({
                        type: "GET",
                        url: "/JobClosure/LoadJobCostinData",
        ...
        Lobibox.confirm({
            ...
            callback: function ($this, type, ev) {
                if (type == "yes") {
                    ...
                    window.open(
                                          "/JobClosure/RequestPrint?JobNo=" + jQuery("#jobno").val(),
                                          '_blank' // <- This is what makes it open in a new window.
                                         );
                    //var check = "";
                    //jQuery.ajax({
                    //    type: "GET",
                    //    url: "/JobClosure/RequestPrint",
                    //    data: { JobNo: jQuery("#jobno").val() },
                    //    contentType: "application/json;charset=utf-8",
                    //    dataType: "json",
                    //    success: function (result) {
            ...
            Lobibox.confirm({
                ...
                callback: function ($this, type, ev) {
                    if (type == "yes") {
                        ...
                        jQuery.ajax({
                            type: "GET",
                            url: "/JobClosure/RemoveCostDetails",
    ...
    function JobOrPouchDetails(code, type) {
        ...
        jQuery.ajax({
            type: "GET",
            url: "/JobClosure/JobOrPouchDetails",
        ...
        Lobibox.confirm({
            ...
            callback: function ($this, type, ev) {
                if (type == "yes") {
                    ...
                    jQuery.ajax({
                        type: "GET",
                        url: "/JobClosure/AddJobCostinData",
    ...
    jQuery(".btn-clear").click(function (evt) {
        ...
        Lobibox.confirm({
            ...
            callback: function ($this, type, ev) {
                if (type == "yes") {
                    window.location.href = "/JobClosure";
                }
            }
        })
