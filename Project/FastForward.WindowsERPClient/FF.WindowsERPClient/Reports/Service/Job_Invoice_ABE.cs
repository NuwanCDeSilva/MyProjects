...
namespace FF.WindowsERPClient.Reports.Service {
    ...
    public class Job_Invoice_ABE : ReportClass {
        
        public Job_Invoice_ABE() {
        }
        
        public override string ResourceName {
            get {
                return "Job_Invoice_ABE.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "FF.WindowsERPClient.Reports.Service.Job_Invoice_ABE.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedJob_Invoice_ABE : Component, ICachedReport {
        
        public CachedJob_Invoice_ABE() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Job_Invoice_ABE rpt = new Job_Invoice_ABE();
            rpt.Site = this.Site;
            return rpt;
        }
