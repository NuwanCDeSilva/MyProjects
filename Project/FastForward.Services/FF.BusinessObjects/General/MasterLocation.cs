...
namespace FF.BusinessObjects
{
    public class MasterLocation
    {
        ...
        private string _ml_agent_cd; //Add tharanga 2018/07/20
        private Int32 _ml_auto_job_create; //Add tharanga 2018/07/20
        private Int32 _ml_agent_internal; //Add tharanga 2018/07/20
        #endregion
        ...
        public string Ml_agent_cd { get { return _ml_agent_cd; } set { _ml_agent_cd = value; } }
        public Int32 Ml_auto_job_create { get { return _ml_auto_job_create; } set { _ml_auto_job_create = value; } }
        public Int32 Ml_agent_internal { get { return _ml_agent_internal; } set { _ml_agent_internal = value; } }
        ...
        public static MasterLocation ConverterTotal(DataRow row)
        {
            return new MasterLocation
            {
                ...
                Ml_agent_cd = row["Ml_agent_cd"] == DBNull.Value ? string.Empty : row["Ml_agent_cd"].ToString(),
                Ml_auto_job_create = row["Ml_auto_job_create"] == DBNull.Value ? 0 : Convert.ToInt32(row["Ml_auto_job_create"]),
                Ml_agent_internal = row["Ml_agent_internal"] == DBNull.Value ? 0 : Convert.ToInt32(row["Ml_agent_internal"]),
            };
        }
    }
}
