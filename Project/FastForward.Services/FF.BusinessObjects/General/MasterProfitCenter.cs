...
namespace FF.BusinessObjects
{
    ...
    public class MasterProfitCenter
    {
        ...
        public Int32 mpc_cash_ins
        {
            get { return _mpc_cash_ins; }
            set { _mpc_cash_ins = value; }
        }
        ...
        public String Mpc_main_pc{ get; set; }
        public String Mpc_town { get; set; }
        public Int32 Mpc_ce_stus { get; set; }

        public String Mpc_main_pccom { get; set; }
        public static MasterProfitCenter ConvertTotal(DataRow row)
        {
            return new MasterProfitCenter
            {
                ...
                Mpc_main_pc = row["MPC_MAIN_PC"] == DBNull.Value ? string.Empty : row["MPC_MAIN_PC"].ToString(),
                Mpc_town = row["MPC_TOWN"] == DBNull.Value ? string.Empty : row["MPC_TOWN"].ToString(),
            };
        ...
        public static MasterProfitCenter ConvertTotalNEW(DataRow row)
        {
            return new MasterProfitCenter
            {
                Mpc_act = row["MPC_ACT"] == DBNull.Value ? false : Convert.ToBoolean(row["MPC_ACT"]),
                ...
                Mpc_main_pc = row["MPC_MAIN_PC"] == DBNull.Value ? string.Empty : row["MPC_MAIN_PC"].ToString(),
                Mpc_town = row["MPC_TOWN"] == DBNull.Value ? string.Empty : row["MPC_TOWN"].ToString(),
                Mpc_ce_stus = row["mpc_ce_stus"] == DBNull.Value ? 0 : Convert.ToInt32(row["mpc_ce_stus"]),
                Mpc_main_pccom = row["mpc_main_pccom"] == DBNull.Value ? string.Empty : row["mpc_main_pccom"].ToString(),
            };
