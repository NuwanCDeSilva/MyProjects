<%@ Page Title="" Language="C#" MasterPageFile="~/View/AdminSite.Master" AutoEventWireup="true" CodeBehind="WharfAndCustoms.aspx.cs" Inherits="FastForward.SCMWeb.View.Reports.Wharf.WharfAndCustoms" %>
                        ...
                        <div class="col-sm-12 col-md-12 panel panel-default">
                            <div class="row buttonRow" id="HederBtn">
                                <div class="col-sm-12 col-md-12">
                                    <div class="col-md-5">
                                        <h1 style="font-size: small; margin-top: 2px"></h1>
                                    </div>
                                    <div class="col-md-5">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12">
                                                    ...
                                                    <div class="col-sm-11 col-md-11 labelText1" style="padding-left: 3px; padding-right: 3px">
                                                         <asp:Label ID="Label1" runat="server" Text="Wharf Entry Clear Details"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>     
                                             <div class="row">
                                                <div class="col-sm-12 col-md-12">
                                                    ...
                                                    <div class="col-sm-11 col-md-11 labelText1" style="padding-left: 3px; padding-right: 3px">
                                                        <asp:Label ID="Label2" runat="server" Text="Entry Clearing"></asp:Label>
                                                    </div>
                                                </div>
                                            </div>                                      
                                                                                            ...
                                                                                            <div class="col-sm-12 col-md-12 padding0">
                                                                                                ...
                                                                                                <div class="row">
                                                                                                    ...
                                                                                                    <div class="col-sm-6 col-md-6" style="height: 25px;">
                                                                                                        <div class="form-group input-group lab col-md-12">
                                                                                                            <div class="col-sm-1 col-md-1" style="margin-top: 3px;">
                                                                                                                <asp:RadioButton runat="server" ID="RadioButtonUser" GroupName="CusdecrepType" Enabled="false"></asp:RadioButton>
                                                                                                            </div>
                                                                                                            <div class="col-sm-2 col-md-2 labelText1 paddingLeft0">
                                                                                                                <asp:Label runat="server">User Wise</asp:Label>
                                                                                                            </div>
                                                                                                            <div class="col-sm-1 col-md-1" style="padding-left: 10px; margin-top: 3px;">
                                                                                                                <asp:RadioButton runat="server" ID="RadioButtonCompany" GroupName="CusdecrepType" Enabled="false"></asp:RadioButton>
                                                                                                            </div>
                                                                                                            <div class="col-sm-2 col-md-2 labelText1 paddingLeft0">
                                                                                                                <asp:Label runat="server">Company Wise</asp:Label>
                                                                                                            </div>
                                                                                                            <div class="col-sm-1 col-md-1" style="margin-top: 3px;">
                                                                                                                <asp:RadioButton runat="server" ID="RadioButtonShippingline" GroupName="CusdecrepType" Enabled="false"></asp:RadioButton>
                                                                                                            </div>
                                                                                                            <div class="col-sm-4 col-md-2 labelText1 paddingLeft0">
                                                                                                                <asp:Label runat="server">ShippingLine Wise</asp:Label>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                         </div>
