...
{
    public partial class FFSevCommonSearchBLL : ServiceBase
    {
        internal static ServiceHost myServiceHost = null;
        public FFSevCommonSearchBLL()
        {
            InitializeComponent();
        }
        ...
        protected override void OnStart(string[] args)
        {
            try
            {
                ...
                myServiceHost = new ServiceHost(typeof(FF.BusinessLogicLayer.CommonSearchBLL));
                myServiceHost.Open();
            }
            catch (Exception ex)
            {
