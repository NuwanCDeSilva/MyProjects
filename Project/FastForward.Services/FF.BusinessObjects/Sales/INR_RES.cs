...
namespace FF.BusinessObjects
{
    ...
    // Computer :- ITPD12  | User :- pemil On 21-Aug-2015 04:21:53
    //===========================================================================================================
    [Serializable]
    public class INR_RES
    {
        ...
        public List<INR_RES_DET> Inr_res_det = null;
        public List<INR_RES_LOG> Inr_res_log = null;
        public DateTime IRS_EXPTED_DT { get; set; }
        ...
        public static INR_RES ConverterNewN(DataRow row)
        {
            return new INR_RES
            {
                IRS_SEQ = row["IRS_SEQ"] == DBNull.Value ? 0 : Convert.ToInt32(row["IRS_SEQ"].ToString()),
                ...
                IRS_MOD_DT = row["IRS_MOD_DT"] == DBNull.Value ? DateTime.MinValue : Convert.ToDateTime(row["IRS_MOD_DT"].ToString()),
                IRS_MOD_SESSION = row["IRS_MOD_SESSION"] == DBNull.Value ? string.Empty : row["IRS_MOD_SESSION"].ToString(),
                IRS_EXPTED_DT = row["IRS_EXPTED_DT"] == DBNull.Value ? DateTime.MinValue : Convert.ToDateTime(row["IRS_EXPTED_DT"].ToString())
