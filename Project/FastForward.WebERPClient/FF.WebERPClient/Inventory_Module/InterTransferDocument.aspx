<%@ Page Title="Inter Transfer Note" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="InterTransferDocument.aspx.cs" Inherits="FF.WebERPClient.Inventory_Module.InterTransferDocument" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        //            var selectedType = document.getElementById("ddlRequestSubType").value.toUpperCase();
                ...
                <ContentTemplate>
                    <asp:UpdatePanel ID="updPnlMRNDataEntry" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <asp:Button ID="btnApproved" runat="server" Text="Approved" CssClass="Button" OnClick="btnMRNApproved_Click" />
                            ...
                            <div style="float: left; width: 100%; padding-left: 25px; padding-right: 25px; font-family: Verdana;
                                ...
                                <div style="float: left; width: 52%;">
                                    ...
                                    <div class="innerRightDivCss">
                                        <asp:DropDownList ID="ddlRequestSubType" runat="server" CssClass="ComboBox" AppendDataBoundItems="True"
                                            AutoPostBack="True" Width="160px" OnSelectedIndexChanged="ddlRequestSubType_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="innerLeftDivCss">
                                        Dispatch Company</div>
                                    <div class="innerRightDivCss">
                                        <asp:DropDownList ID="ddlCompany" runat="server" AppendDataBoundItems="True" AutoPostBack="True"
                                            Width="100px">
                                        </asp:DropDownList>
                                    </div>
                                    <div class="innerLeftDivCss">
                                        Dispatch Location</div>
                                    <div class="innerRightDivCss">
                                ...
                                <div style="float: left; width: 48%;" id="divInvoiceData" clientidmode="Static" runat="server"
                                    ...
                                    <div class="innerLeftDivCss">
                                        Customer Code :</div>
                                    <div class="innerRightDivCss">
                                        <asp:TextBox ID="txtCustomerCode" runat="server" CssClass="commonDDLCss" ClientIDMode="Static"
                                            Enabled="false"></asp:TextBox>
                                    </div>
                                    <div class="innerLeftDivCss">
                                        Customer Name :</div>
                                    <div class="innerRightDivCss">
                                        <asp:TextBox ID="txtCustomerName" runat="server" CssClass="commonDDLCss" ClientIDMode="Static"
                                            Enabled="false"></asp:TextBox>
                                    </div>
                                    <div class="innerLeftDivCss">
                                        Address 1 :</div>
                                    <div class="innerRightDivCss">
                                        <asp:TextBox ID="txtAddress1" runat="server" CssClass="commonDDLCss" ClientIDMode="Static"
                                            Enabled="false"></asp:TextBox>
                                    </div>
                                    <div class="innerLeftDivCss">
                                        Address 2 :</div>
                                    <div class="innerRightDivCss">
                                        <asp:TextBox ID="txtAddress2" runat="server" CssClass="commonDDLCss" ClientIDMode="Static"
                                            Enabled="false"></asp:TextBox>
                                    </div>
                                </div>
                                <div style="float: left; width: 48%;" id="divAdvanceData" clientidmode="Static" runat="server"
                                    visible="false">
                                    <div class="innerLeftDivCss">
                                        Receipt No :</div>
                                    <div class="innerRightDivCss">
                                        <asp:TextBox ID="txtReceiptNo" runat="server" CssClass="commonDDLCss" ClientIDMode="Static"></asp:TextBox>
                                        <asp:ImageButton ID="imgReceiptNo" runat="server" ImageUrl="~/Images/icon_search.png"
                                            OnClick="imgReceiptNo_Click" />
                                    </div>
                                    <div class="innerLeftDivCss">
                                        Customer Code :</div>
                                    <div class="innerRightDivCss">
                                        <asp:TextBox ID="txtReceiptCustCode" runat="server" CssClass="commonDDLCss" ClientIDMode="Static"
                                            Enabled="false"></asp:TextBox>
                                    </div>
                                    <div class="innerLeftDivCss">
                                        Customer Name :</div>
                                    <div class="innerRightDivCss">
                                        <asp:TextBox ID="txtReceiptCustName" runat="server" CssClass="commonDDLCss" ClientIDMode="Static"
                                            Enabled="false"></asp:TextBox>
                                    </div>
                                    <div class="innerLeftDivCss">
                                        Address 1 :</div>
                                    <div class="innerRightDivCss">
                                        <asp:TextBox ID="txtReceiptAdd1" runat="server" CssClass="commonDDLCss" ClientIDMode="Static"
                                            Enabled="false"></asp:TextBox>
                                    </div>
                                    <div class="innerLeftDivCss">
                                        Address 2 :</div>
                                    <div class="innerRightDivCss">
                                        <asp:TextBox ID="txtReceiptAdd2" runat="server" CssClass="commonDDLCss" ClientIDMode="Static"
                                            Enabled="false"></asp:TextBox>
                                    </div>
                                </div>
                                <div style="float: left; width: 48%;" id="divDisplayData" clientidmode="Static" runat="server"
                                    visible="false">
                                    <div class="innerLeftDivCss">
                                        <asp:CheckBox ID="chkForDisplay" runat="server" CssClass="commonDDLCss" ClientIDMode="Static"
                                            Text="Display Purpose" Enabled="false" />
                                    </div>
                                </div>
                            </div>
                            <%--Request Header Area--%>
                            ...
                            <div style="display: none;">
                                <asp:Button ID="btnGetReceipt" runat="server" OnClick="GetReceiptDetails" />
                                <asp:Button ID="btnGetdispatchlocation" runat="server" OnClick="GetGetdispatchlocation" />
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </ContentTemplate>
                ...
                <ContentTemplate>
                    <asp:UpdatePanel ID="updPnlMRNList" runat="server">
                        <ContentTemplate>
                            <br />
                            <div class="MainDivCss">
                                <table style="border: 0; border-collapse: 2; border-spacing: 0;">
                                    <tr>
