...
namespace FF.BusinessObjects
{
    ...
    public class InventoryRequestItem : MasterItem
    {
        ...
        public string Itri_old_itm_cd { get; set; }
        public string Itri_itm_mod_by { get; set; }
        public DateTime Itri_itm_mod_dt { get; set; }
        public string Itri_itm_mod_session { get; set; }
        ...
        private Int32 _itri_is_auto_app = 0; //kapila 21/6/2017
        private string _itri_itm_newstus; //Rukshan 19/Feb/2016
        
        #endregion

        #region Public Property Definition
        public Int32 Itri_is_auto_app
        {
            get { return _itri_is_auto_app; }
            set { _itri_is_auto_app = value; }
        }
        //kapila 3/7/2015
        ...
        public string MainCompoitm { 
            get{return _MainCompoitm;} 
            set{_MainCompoitm=value;}
        }
        ...
        public int Tmp_itm_select  { get; set; }
        public string Tmp_kit_cd { get; set; }
        public Int32 Itri_line_no_tmp { get; set; }
        public decimal Tmp_base_doc_bal { get; set; }
        public string Tmp_itm_uom { get; set; }
        public string Tmp_itm_model { get; set; }
        public Int32 mi_is_ser1 { get; set; } // Dilshan 2017-11-06
        public string Tmp_itm_tp { get; set; } //Add  by lakshan 05Mar2018
        public string itri_itm_newstus
        {
            get { return _itri_itm_newstus; }
            set { _itri_itm_newstus = value; }
        }
        public String Mi_part_no { get; set; } // Dilshan 2017-11-06
        #endregion
        ...
        public static InventoryRequestItem ConverterDispatchPlan(DataRow row)
        {
            return new InventoryRequestItem
            {
                ...
                mi_is_ser1 = row["MI_IS_SER1"] == DBNull.Value ? 0 : Convert.ToInt32(row["MI_IS_SER1"]),
                Mi_longdesc = row["Mi_longdesc"] == DBNull.Value ? string.Empty : Convert.ToString(row["MI_LONGDESC"]),
                Itri_note = row["itri_note"] == DBNull.Value ? string.Empty : Convert.ToString(row["itri_note"]),
                
            };
        }
        //dilshan on 30/08/2018
        public static InventoryRequestItem ConverterDispatchPlanNew(DataRow row)
        {
            return new InventoryRequestItem
            {
                Itri_seq_no = row["Itri_seq_no"] == DBNull.Value ? 0 : Convert.ToInt32(row["Itri_seq_no"]),
                ...
                Mi_longdesc = row["Mi_longdesc"] == DBNull.Value ? string.Empty : Convert.ToString(row["MI_LONGDESC"]),
                Itri_note = row["itri_note"] == DBNull.Value ? string.Empty : Convert.ToString(row["itri_note"]),
                Mi_part_no = row["Mi_part_no"] == DBNull.Value ? string.Empty : Convert.ToString(row["Mi_part_no"]),
            };
        }
        ...
        public static InventoryRequestItem Converter4(DataRow row)
        {
            return new InventoryRequestItem
            {
                Itri_itm_cd = row["ITRI_ITM_CD"] == DBNull.Value ? string.Empty : row["ITRI_ITM_CD"].ToString(),
        ...
        public static InventoryRequestItem ConverterForCommonOut_3(DataRow row)
        {
            return new InventoryRequestItem
            {
